...
export default function Page(){
 ...
 return <main className="conj-page conj-pro" dir="rtl">
  ...
  <section className="conj-heading"><div><span>{group(v)}</span><h1 dir="ltr">{v}</h1><h2>{AR[v]||"فعل فرنسي"}</h2><div className="conj-verb-meta" dir="ltr"><b>{regularity(v)}</b><b>{trait(v)}</b><b>auxiliaire: {a}</b><b>participe passé: {pp}</b></div></div><button onClick={()=>speak(v)}><Volume2/></button></section>
  <UsagePanel verb={v}/>
