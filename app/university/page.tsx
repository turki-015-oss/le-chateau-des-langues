...
}function A1StudyPresentationCarousel({kind="study"}:{kind?:"study"|"profession"}){
 const [presentationIndex,setPresentationIndex]=useState(0);
 const cards=kind==="study"?A1_STUDY_PRESENTATION_CARDS:A1_PROFESSION_PRESENTATION_CARDS;
