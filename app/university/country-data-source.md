...
`nationality-data.ts` is a fixed snapshot of French masculine and feminine demonyms from [mledoze/countries](https://github.com/mledoze/countries), with targeted corrections to forms for Antigua and Barbuda, Eswatini, New Zealand, the United Arab Emirates, Saudi Arabia, and Vatican City. The source dataset is ODbL 1.0 under the license copied beside the flags. The application never requests this data at runtime. Arabic text in the nationality cards is a country-of-origin paraphrase, not a claim that Arabic adjectives are identical across genders.
