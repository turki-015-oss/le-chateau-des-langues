...
export default function Page(){
 ...
 return <main className="conj-page conj-pro" dir="rtl">
  ...
  <section className="conj-heading"><div><span>{group(v)}</span><h1 dir="ltr">{v}</h1><h2>{AR[v]||"فعل فرنسي"}</h2><p>تصريفات واضحة، وأمثلة سياقية مراجعة في الحاضر. يضيف هذا الإصدار الدفعة الثالثة من الأفعال غير الضميرية مع استعمالاتها وترجمة عربية كاملة ونطق احترافي.</p><div className="conj-review-progress">v5.0 · دفعة المراجعة الثالثة · لا تُعرض أمثلة آلية غير موثوقة</div></div><button onClick={()=>speak(v)}><Volume2/></button></section>
  <UsagePanel verb={v}/>
