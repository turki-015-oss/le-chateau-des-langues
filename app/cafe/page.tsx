...
export default function CafePage(){
 ...
 return <main className="c31-page">
  <header className="c31-top"><Link href="/kingdom" className="c31-back"><ArrowRight/> <span><b>Carte du Royaume</b><small>خريطة المملكة</small></span></Link><div className="c31-brand"><Coffee/><div><b>Chez Luc</b><small>مقهى لوك</small></div></div></header>
