...
const A1_TASTES_REASON_SECTIONS=[
 ...
 {fr:"Comparer",ar:"المقارنة",note:"مع préférer نستعمل à / au / aux قبل الخيار الثاني.",items:[{fr:"Je préfère le thé au café.",ar:"أفضل الشاي على القهوة."},{fr:"Nous préférons le train à la voiture.",ar:"نفضل القطار على السيارة."},{fr:"Il préfère lire aux jeux vidéo.",ar:"هو يفضل القراءة على ألعاب الفيديو."}]}
] as const;
