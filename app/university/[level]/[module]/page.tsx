...
export default async function UniversityLessonPage({params,searchParams}:{params:Promise<{level:string;module:string}>;searchParams:Promise<{phase?:string;focus?:string}>}){
