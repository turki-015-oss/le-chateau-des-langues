...
import {
 ...
 Tags,Telescope,Trash2,Trophy,Turtle,UserRoundCog,Users,UsersRound,Volume2,WandSparkles
} from "lucide-react";
...
const A1_GREETINGS_LISTENING_CLIPS=[
 {letter:"Bonjour,",word:"monsieur.",ar:"مرحبًا يا سيدي.",hiddenSpeech:"Bonjour, monsieur."},
 {letter:"Bonsoir,",word:"monsieur.",ar:"مساء الخير يا سيدي.",hiddenSpeech:"Bonsoir, monsieur."},
 {letter:"Salut,",word:"Adam !",ar:"مرحبًا يا آدم!",hiddenSpeech:"Salut, Adam !"},
 {letter:"Comment",word:"allez-vous ?",ar:"كيف حالك؟",hiddenSpeech:"Comment allez-vous ?"},
 {letter:"Ça",word:"va ?",ar:"كيف الحال؟",hiddenSpeech:"Ça va ?"},
 {letter:"Je vais bien,",word:"merci.",ar:"أنا بخير، شكرًا.",hiddenSpeech:"Je vais bien, merci."},
 {letter:"Je m’appelle",word:"Karim.",ar:"اسمي كريم.",hiddenSpeech:"Je m’appelle Karim."},
 {letter:"Salut ! Je suis",word:"Adam. Et toi ?",ar:"مرحبًا! أنا آدم. وأنت؟",hiddenSpeech:"Salut ! Je suis Adam. Et toi ?"},
 {letter:"Je viens",word:"du Maroc.",ar:"أنا من المغرب.",hiddenSpeech:"Je viens du Maroc."},
 {letter:"J’habite",word:"à Lyon.",ar:"أسكن في ليون.",hiddenSpeech:"J’habite à Lyon."},
 {letter:"Je parle arabe",word:"et un peu français.",ar:"أتحدث العربية وقليلًا من الفرنسية.",hiddenSpeech:"Je parle arabe et un peu français."},
 {letter:"Au revoir,",word:"monsieur.",ar:"إلى اللقاء يا سيدي.",hiddenSpeech:"Au revoir, monsieur."},
 {letter:"À",word:"bientôt !",ar:"أراك قريبًا!",hiddenSpeech:"À bientôt !"}
];
...
const A1_CORE_VERBS_LISTENING_CLIPS=[
 {letter:"je suis",word:"en classe",ar:"أنا في الصف",hiddenSpeech:"Je suis en classe."},
 {letter:"tu as",word:"un livre",ar:"لديك كتاب",hiddenSpeech:"Tu as un livre."},
 {letter:"il est",word:"à Paris",ar:"هو في باريس",hiddenSpeech:"Il est à Paris."},
 {letter:"elle a",word:"deux frères",ar:"لديها أخوان",hiddenSpeech:"Elle a deux frères."},
 {letter:"on est",word:"ici",ar:"نحن هنا",hiddenSpeech:"On est ici."},
 {letter:"nous avons",word:"un cours",ar:"لدينا درس",hiddenSpeech:"Nous avons un cours."},
 {letter:"vous êtes",word:"à l’école",ar:"أنتم في المدرسة",hiddenSpeech:"Vous êtes à l’école."},
 {letter:"ils sont",word:"étudiants",ar:"هم طلاب",hiddenSpeech:"Ils sont étudiants."},
...
const A1_HOME_HOUSING_LISTENING_CLIPS=[
 ...
 {letter:"deux",word:"chambres",ar:"غرفتا نوم",hiddenSpeech:"Deux chambres"},
 {letter:"un petit",word:"balcon",ar:"شرفة صغيرة",hiddenSpeech:"Un petit balcon"},
...
const A1_MODULES:CourseModule[]=[
 ...
 },
 {
  ...
  sections:[
   section("Le genre des noms","تذكير الأسماء وتأنيثها","لكل اسم جنس نحوي: مذكر أو مؤنث. عرضنا الأسماء مع le للمذكر وla للمؤنث لتسهيل تمييز جنسها للمبتدئ، وهما أداتا تعريف وليستا أداتي نكرة. عند الحديث عن شخص أو شيء غير محدد نستخدم un للمذكر وune للمؤنث.",[
 ...
 },
 {
  ...
  sections:[
   section("Le masculin singulier : ce et cet","المذكر المفرد: ce وcet","تأتي صفة الإشارة قبل الاسم المذكر المفرد. نستعمل ce قبل صوت ساكن، ونستعمل cet قبل صوت متحرك أو h صامت. استخدم الجدول للتنقل بين الأمثلة الثمانية.",[
    "ce + اسم مذكر مفرد يبدأ بصوت ساكن: ce livre.",
    "cet + اسم مذكر مفرد يبدأ بصوت متحرك أو h صامت: cet hôtel.",
   ...
   section("Le pluriel : ces","الجمع للمذكر والمؤنث: ces","نستعمل ces قبل جميع الأسماء في صيغة الجمع، سواء كانت مذكرة أو مؤنثة. استخدم الجدول للتنقل بين الأمثلة الثمانية.",[
...
const A1_SOUNDS_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"Dans le mot « livre », comment classe-t-on la voyelle /i/ ?",speech:"Dans le mot livre, comment classe-t-on la voyelle i ?",translation:"كيف نصنّف الصوت /i/ في كلمة «livre»؟",instruction:"اختر التصنيف الصحيح.",choices:["Orale et non arrondie — فمي وغير مدوّر","Nasale et arrondie — أنفي ومدوّر","Orale et arrondie — فمي ومدوّر"],correctIndex:0,explanation:"الصوت /i/ فموي وغير مدوّر؛ يخرج الهواء من الفم وتكون الشفتان مبسوطتين."},
 ...
 {prompt:"Dans quel mot entend-on une voyelle moyenne fermée /e/ ?",speech:"Dans quel mot entend-on la voyelle moyenne fermée é ? Tasse, terre ou bébé ?",translation:"في أي كلمة نسمع صوتًا متوسطًا مغلقًا /e/؟",instruction:"اختر الكلمة الصحيحة.",choices:["tasse","terre","bébé"],correctIndex:2,explanation:"تحتوي كلمة bébé على /e/، وهو صوت متوسط مغلق."},
 {prompt:"Dans quel mot entend-on une voyelle moyenne ouverte /ɛ/ ?",speech:"Dans quel mot entend-on la voyelle moyenne ouverte è ? Fête, riz ou roue ?",translation:"في أي كلمة نسمع صوتًا متوسطًا مفتوحًا /ɛ/؟",instruction:"اختر الكلمة الصحيحة.",choices:["fête","riz","roue"],correctIndex:0,explanation:"تحتوي كلمة fête على /ɛ/، وهو صوت متوسط مفتوح."},
 {prompt:"Dans quel mot entend-on une voyelle ouverte /a/ ?",speech:"Dans quel mot entend-on la voyelle ouverte a ? Rue, table ou nez ?",translation:"في أي كلمة نسمع صوتًا متحركًا مفتوحًا /a/؟",instruction:"اختر الكلمة الصحيحة.",choices:["rue","table","nez"],correctIndex:1,explanation:"تحتوي كلمة table على /a/؛ ينخفض اللسان وينفتح الفم عند نطقه."},
 {prompt:"Quel mot contient la semi-voyelle /j/ ?",speech:"Quel mot contient la semi-voyelle yod ? Mur, sac ou bien ?",translation:"أي كلمة تحتوي على شبه حرف العلة /j/ القريب من الياء؟",instruction:"اختر الكلمة الصحيحة.",choices:["mur","sac","bien"],correctIndex:2,explanation:"تبدأ المجموعة الصوتية في bien بانزلاق /j/ سريع قبل الصوت المتحرك."},
 {prompt:"Quel mot contient la semi-voyelle /w/ ?",speech:"Quel mot contient la semi-voyelle ou ? Soir, bus ou clé ?",translation:"أي كلمة تحتوي على شبه حرف العلة /w/ القريب من الواو؟",instruction:"اختر الكلمة الصحيحة.",choices:["soir","bus","clé"],correctIndex:0,explanation:"تحتوي كلمة soir على شبه حرف العلة /w/ ضمن النطق /swaʁ/."},
 {prompt:"Quel mot contient la semi-voyelle /ɥ/ ?",speech:"Quel mot contient la semi-voyelle u ? Porte, nuit ou vélo ?",translation:"أي كلمة تحتوي على شبه حرف العلة /ɥ/، وهو صوت الواو الفرنسية الخفيفة؟",instruction:"اختر الكلمة الصحيحة.",choices:["porte","nuit","vélo"],correctIndex:1,explanation:"تحتوي كلمة nuit على الانزلاق /ɥ/ قبل الصوت /i/."},
 {prompt:"Dans « souris », quel groupe de lettres produit le son /u/ ?",speech:"Dans souris, quel groupe de lettres produit le son ou ?",translation:"في كلمة «souris»، ما مجموعة الحروف التي تنتج الصوت /u/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["oi","eau","ou"],correctIndex:2,explanation:"تنتج المجموعة ou الصوت /u/ في كلمة souris."},
 {prompt:"Dans « poisson », quel groupe de lettres produit le son /wa/ ?",speech:"Dans poisson, quel groupe de lettres produit le son wa ?",translation:"في كلمة «poisson»، ما مجموعة الحروف التي تنتج الصوت /wa/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["oi","on","in"],correctIndex:0,explanation:"تنتج المجموعة oi الصوت /wa/ في بداية كلمة poisson."},
 {prompt:"Dans « château », quel groupe de lettres produit le son /o/ ?",speech:"Dans château, quel groupe de lettres produit le son o ?",translation:"في كلمة «château»، ما مجموعة الحروف التي تنتج الصوت /o/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["eu","eau","ai"],correctIndex:1,explanation:"تنتج المجموعة eau الصوت /o/ في نهاية كلمة château."},
 {prompt:"Dans « montagne », quel groupe de lettres produit le son /ɲ/ ?",speech:"Dans montagne, quel groupe de lettres produit le son gn ?",translation:"في كلمة «montagne»، ما مجموعة الحروف التي تنتج الصوت /ɲ/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["ch","ph","gn"],correctIndex:2,explanation:"تمثل المجموعة gn الصوت /ɲ/ في كلمة montagne."},
 {prompt:"Dans « photo », quel groupe de lettres produit le son /f/ ?",speech:"Dans photo, quel groupe de lettres produit le son f ?",translation:"في كلمة «photo»، ما مجموعة الحروف التي تنتج الصوت /f/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["ph","th","qu"],correctIndex:0,explanation:"تُنطق المجموعة ph بالصوت /f/ في كلمة photo."},
 {prompt:"Dans « chemise », quel groupe de lettres produit le son /ʃ/ ?",speech:"Dans chemise, quel groupe de lettres produit le son ch ?",translation:"في كلمة «chemise»، ما مجموعة الحروف التي تنتج الصوت /ʃ/؟",instruction:"اختر مجموعة الحروف الصحيحة.",choices:["ge","ch","ss"],correctIndex:1,explanation:"تُنطق المجموعة ch بالصوت /ʃ/ في بداية كلمة chemise."}
];
...
const A1_GREETINGS_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"Il est neuf heures du matin. Que dites-vous ?",speech:"Il est neuf heures du matin. Que dites-vous ?",translation:"الساعة التاسعة صباحًا، ماذا تقول؟",instruction:"اختر التحية المناسبة في الصباح.",choices:["Bonsoir !","Bonjour !","Bonne nuit !"],correctIndex:1,explanation:"Bonjour هي التحية المناسبة في الصباح وخلال النهار."},
 {prompt:"Vous rencontrez quelqu’un le soir. Que dites-vous ?",speech:"Vous rencontrez quelqu’un le soir. Que dites-vous ?",translation:"تقابل شخصًا مساءً، ماذا تقول؟",instruction:"اختر التحية المناسبة عند اللقاء مساءً.",choices:["À demain !","Bonne nuit !","Bonsoir !"],correctIndex:2,explanation:"Bonsoir تحية مناسبة عند مقابلة شخص في المساء."},
 {prompt:"Vous rencontrez un ami. Quelle salutation familière choisissez-vous ?",speech:"Vous rencontrez un ami. Quelle salutation familière choisissez-vous ?",translation:"تقابل صديقًا، أي تحية ودية تختار؟",instruction:"اختر التحية الودية المناسبة لصديق.",choices:["Salut !","Au revoir !","Bonne nuit !"],correctIndex:0,explanation:"Salut تحية غير رسمية تُستخدم مع الأصدقاء."},
 {prompt:"Vous rencontrez monsieur Martin le matin. Que dites-vous ?",speech:"Vous rencontrez monsieur Martin le matin. Que dites-vous ?",translation:"تقابل السيد مارتان صباحًا، ماذا تقول؟",instruction:"اختر تحية مهذبة تناسب الموقف.",choices:["À bientôt, monsieur !","Bonjour, monsieur !","Bonne nuit, monsieur !"],correctIndex:1,explanation:"Bonjour, monsieur تحية مهذبة مناسبة في الصباح."},
 {prompt:"Votre ami va se coucher. Que lui dites-vous ?",speech:"Votre ami va se coucher. Que lui dites-vous ?",translation:"صديقك ذاهب للنوم، ماذا تقول له؟",instruction:"اختر العبارة المناسبة قبل النوم.",choices:["Bonjour !","Bienvenue !","Bonne nuit !"],correctIndex:2,explanation:"Bonne nuit تُقال عند توديع شخص ذاهب للنوم."},
 {prompt:"Vous partez. Quelle formule de départ choisissez-vous ?",speech:"Vous partez. Quelle formule de départ choisissez-vous ?",translation:"ستغادر، أي عبارة وداع تختار؟",instruction:"اختر عبارة الوداع المناسبة.",choices:["Au revoir !","Enchanté !","Bonjour !"],correctIndex:0,explanation:"Au revoir عبارة وداع عامة."},
 {prompt:"Vous reverrez votre ami demain. Que dites-vous ?",speech:"Vous reverrez votre ami demain. Que dites-vous ?",translation:"سترى صديقك غدًا، ماذا تقول؟",instruction:"اختر عبارة الوداع التي تشير إلى الغد.",choices:["Bonsoir !","À demain !","Bienvenue !"],correctIndex:1,explanation:"À demain تعني إلى الغد."},
 {prompt:"Vous espérez revoir votre ami bientôt. Que dites-vous ?",speech:"Vous espérez revoir votre ami bientôt. Que dites-vous ?",translation:"تأمل أن ترى صديقك قريبًا، ماذا تقول؟",instruction:"اختر عبارة الوداع المناسبة.",choices:["Bonne nuit !","Je m’appelle Sami.","À bientôt !"],correctIndex:2,explanation:"À bientôt تعني إلى لقاء قريب."},
 {prompt:"Quelle question posez-vous pour demander poliment des nouvelles de quelqu’un ?",speech:"Quelle question posez-vous pour demander poliment des nouvelles de quelqu’un ?",translation:"كيف تسأل شخصًا عن حاله بصيغة رسمية؟",instruction:"اختر السؤال المناسب عن الحال.",choices:["Comment allez-vous ?","Comment vous appelez-vous ?","Où habitez-vous ?"],correctIndex:0,explanation:"Comment allez-vous ? سؤال مهذب عن الحال."},
 {prompt:"Quelle question posez-vous à un ami pour savoir comment il va ?",speech:"Quelle question posez-vous à un ami pour savoir comment il va ?",translation:"كيف تسأل صديقًا عن حاله؟",instruction:"اختر السؤال الودي المناسب عن الحال.",choices:["Quel âge as-tu ?","Comment vas-tu ?","Comment t’appelles-tu ?"],correctIndex:1,explanation:"Comment vas-tu ? سؤال عن حال صديق بصيغة tu."},
 {prompt:"Comment allez-vous ? Quelle réponse convient ?",speech:"Comment allez-vous ? Quelle réponse convient ?",translation:"كيف حالك؟ ما الرد المناسب؟",instruction:"اختر الرد المناسب عن الحال.",choices:["Je m’appelle Sami.","À demain.","Très bien, merci."],correctIndex:2,explanation:"Très bien, merci رد طبيعي على السؤال عن الحال."},
 {prompt:"Quelle question posez-vous pour demander le nom d’une personne avec « vous » ?",speech:"Quelle question posez-vous pour demander le nom d’une personne avec vous ?",translation:"كيف تسأل شخصًا عن اسمه بصيغة «vous»؟",instruction:"اختر السؤال الرسمي عن الاسم.",choices:["Comment vous appelez-vous ?","Comment allez-vous ?","Où habitez-vous ?"],correctIndex:0,explanation:"Comment vous appelez-vous ? سؤال عن الاسم بصيغة مهذبة."},
 {prompt:"Vous voulez dire votre nom. Quelle phrase choisissez-vous ?",speech:"Vous voulez dire votre nom. Quelle phrase choisissez-vous ?",translation:"تريد ذكر اسمك، أي جملة تختار؟",instruction:"اختر الجملة التي تُعرّف بها نفسك.",choices:["Il s’appelle Sami.","Je m’appelle Sami.","Tu t’appelles Sami."],correctIndex:1,explanation:"Je m’appelle Sami تعني اسمي سامي."},
 {prompt:"Vous présentez Karim à quelqu’un. Que dites-vous ?",speech:"Vous présentez Karim à quelqu’un. Que dites-vous ?",translation:"تُعرّف شخصًا على كريم، ماذا تقول؟",instruction:"اختر الجملة التي تقدّم بها صديقك.",choices:["Je m’appelle Karim.","Au revoir, Karim.","Voici mon ami Karim."],correctIndex:2,explanation:"Voici mon ami Karim تُستخدم لتقديم صديقك إلى شخص آخر."},
 {prompt:"Quelqu’un vous dit « Enchanté ! ». Que répondez-vous ?",speech:"Quelqu’un vous dit Enchanté. Que répondez-vous ?",translation:"قال لك شخص «تشرفت»، بماذا ترد؟",instruction:"اختر الرد المناسب عند التعارف.",choices:["Moi de même !","Bonne nuit !","À demain !"],correctIndex:0,explanation:"Moi de même تعني وأنا كذلك."},
 {prompt:"On vous dit « Bienvenue dans notre classe ! ». Que répondez-vous ?",speech:"On vous dit Bienvenue dans notre classe. Que répondez-vous ?",translation:"قيل لك «أهلًا بك في صفّنا»، بماذا ترد؟",instruction:"اختر الرد المناسب على الترحيب.",choices:["Je viens de France.","Merci !","Comment allez-vous ?"],correctIndex:1,explanation:"Merci رد مناسب على الترحيب."},
 {prompt:"Quelle phrase indique votre pays d’origine ?",speech:"Quelle phrase indique votre pays d’origine ?",translation:"أي جملة تذكر بلدك الأصلي؟",instruction:"اختر الجملة التي تذكر الأصل.",choices:["J’habite à Nice.","Je parle français.","Je viens de France."],correctIndex:2,explanation:"Je viens de France تذكر بلد الأصل."},
 {prompt:"Quelle phrase indique votre lieu de résidence ?",speech:"Quelle phrase indique votre lieu de résidence ?",translation:"أي جملة تذكر مكان سكنك؟",instruction:"اختر الجملة التي تذكر مكان السكن.",choices:["J’habite à Nice.","J’ai vingt ans.","Je m’appelle Sami."],correctIndex:0,explanation:"J’habite à Nice تذكر مدينة السكن."},
 {prompt:"Quelle phrase indique votre âge ?",speech:"Quelle phrase indique votre âge ?",translation:"أي جملة تذكر عمرك؟",instruction:"اختر الجملة التي تذكر العمر.",choices:["Je suis étudiant.","J’ai vingt ans.","Je viens de France."],correctIndex:1,explanation:"في الفرنسية نستخدم avoir لذكر العمر: J’ai vingt ans."},
 {prompt:"Quelle phrase indique la langue que vous parlez ?",speech:"Quelle phrase indique la langue que vous parlez ?",translation:"أي جملة تذكر اللغة التي تتحدثها؟",instruction:"اختر الجملة التي تذكر اللغة.",choices:["J’habite à Paris.","Je m’appelle Sami.","Je parle arabe."],correctIndex:2,explanation:"Je parle arabe تذكر اللغة التي يتحدثها الشخص."}
];
...
const A1_COUNTRIES_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"J’habite ___ France.",speech:"Quelle préposition utilise-t-on avec France après J’habite ?",instruction:"اختر حرف الجر الصحيح مع France.",translation:"أسكن في فرنسا.",choices:["au","en","aux"],correctIndex:1,explanation:"France بلد مؤنث؛ لذلك نقول en France."},
 {prompt:"Nous allons ___ Maroc.",speech:"Quelle préposition utilise-t-on avec Maroc après Nous allons ?",instruction:"اختر حرف الجر الصحيح مع Maroc.",translation:"نحن ذاهبون إلى المغرب.",choices:["au","en","aux"],correctIndex:0,explanation:"Maroc بلد مذكر؛ لذلك نقول au Maroc."},
 {prompt:"Elle travaille ___ États-Unis.",speech:"Quelle préposition utilise-t-on avec États-Unis après Elle travaille ?",instruction:"اختر حرف الجر الصحيح مع États-Unis.",translation:"هي تعمل في الولايات المتحدة.",choices:["en","au","aux"],correctIndex:2,explanation:"États-Unis اسم جمع؛ لذلك نقول aux États-Unis."},
 {prompt:"Je viens ___ France.",speech:"Quelle préposition indique l’origine avec France ?",instruction:"اختر الصيغة الصحيحة لذكر الأصل.",translation:"أنا من فرنسا.",choices:["de","du","des"],correctIndex:0,explanation:"نقول de France عند ذكر الأصل من بلد مؤنث."},
 {prompt:"Il vient ___ Maroc.",speech:"Quelle forme de la préposition de utilise-t-on avec Maroc ?",instruction:"اختر الصيغة الصحيحة مع بلد مذكر.",translation:"هو من المغرب.",choices:["de la","des","du"],correctIndex:2,explanation:"de + le تصبح du: du Maroc."},
 {prompt:"Ils viennent ___ États-Unis.",speech:"Quelle forme de la préposition de utilise-t-on avec États-Unis ?",instruction:"اختر الصيغة الصحيحة مع بلد جمع.",translation:"هم من الولايات المتحدة.",choices:["des","du","d’"],correctIndex:0,explanation:"de + les تصبح des: des États-Unis."},
 {prompt:"Nora est ___.",speech:"Complétez la phrase sur Nora avec la forme féminine de sa nationalité.",instruction:"اختر صيغة الجنسية المؤنثة الصحيحة.",translation:"نورة فرنسية.",choices:["français","française","France"],correctIndex:1,explanation:"مع امرأة نقول française."},
 {prompt:"Sami est ___.",speech:"Complétez la phrase sur Sami avec la forme masculine de sa nationalité.",instruction:"اختر صيغة الجنسية المذكرة الصحيحة.",translation:"سامي سعودي.",choices:["saoudien","saoudienne","Arabie saoudite"],correctIndex:0,explanation:"مع رجل نقول saoudien."},
 {prompt:"Yuki est ___.",speech:"Complétez la phrase sur Yuki avec la forme féminine de sa nationalité.",instruction:"اختر صيغة الجنسية المؤنثة الصحيحة.",translation:"يوكي يابانية.",choices:["Japon","japonais","japonaise"],correctIndex:2,explanation:"الصيغة المؤنثة من japonais هي japonaise."},
 {prompt:"Je parle ___.",speech:"Après Je parle, quel mot désigne la langue ?",instruction:"اختر اسم اللغة الصحيح بعد parler.",translation:"أتحدث الفرنسية.",choices:["France","français","française"],correctIndex:1,explanation:"français اسم اللغة هنا؛ France اسم البلد، وfrançaise صفة مؤنثة."},
 {prompt:"J’apprends ___.",speech:"Après J’apprends, quelle expression désigne la langue ?",instruction:"اختر الصياغة الصحيحة مع apprendre.",translation:"أتعلم اللغة الفرنسية.",choices:["le français","la France","les Français"],correctIndex:0,explanation:"le français اسم اللغة، أما la France فهي البلد وles Français هم الأشخاص."},
 {prompt:"Elle vient d’Égypte. Elle est ___.",speech:"Complétez la phrase avec la nationalité féminine correspondant à l’Égypte.",instruction:"اختر الجنسية المناسبة.",translation:"هي من مصر، وهي مصرية.",choices:["égyptien","Égypte","égyptienne"],correctIndex:2,explanation:"الصيغة المؤنثة الصحيحة هي égyptienne."},
 {prompt:"En Espagne, on parle ___.",speech:"Quelle langue parle-t-on en Espagne ?",instruction:"اختر اسم اللغة الصحيح.",translation:"في إسبانيا يتحدثون الإسبانية.",choices:["espagnole","espagnol","Espagne"],correctIndex:1,explanation:"اسم اللغة هو espagnol ويكتب بحرف صغير."},
 {prompt:"Il vient d’Allemagne. Il est ___.",speech:"Complétez la phrase avec la nationalité masculine correspondant à l’Allemagne.",instruction:"اختر الجنسية المناسبة.",translation:"هو من ألمانيا، وهو ألماني.",choices:["allemand","allemande","Allemagne"],correctIndex:0,explanation:"الصيغة المذكرة الصحيحة هي allemand."},
 {prompt:"___ venez-vous ?",speech:"Quelle expression permet de demander l’origine d’une personne ?",instruction:"أكمل السؤال عن البلد أو الأصل.",translation:"من أين أنتم؟",choices:["Quelle","D’où","Comment"],correctIndex:1,explanation:"D’où venez-vous ؟ سؤال مباشر عن الأصل."},
 {prompt:"___ langue parlez-vous ?",speech:"Quel mot complète la question sur la langue parlée ?",instruction:"اختر أداة السؤال الموافقة لكلمة langue.",translation:"ما اللغة التي تتحدثون بها؟",choices:["Quel","Quels","Quelle"],correctIndex:2,explanation:"langue مؤنث مفرد؛ لذلك نقول quelle langue."},
 {prompt:"Elle habite ___ Italie.",speech:"Quelle préposition utilise-t-on avec Italie après Elle habite ?",instruction:"اختر حرف الجر الصحيح.",translation:"هي تسكن في إيطاليا.",choices:["en","au","aux"],correctIndex:0,explanation:"Italie بلد مؤنث يبدأ بصوت متحرك؛ لذلك نقول en Italie."},
 {prompt:"Nous habitons ___ Canada.",speech:"Quelle préposition utilise-t-on avec Canada après Nous habitons ?",instruction:"اختر حرف الجر الصحيح.",translation:"نسكن في كندا.",choices:["aux","au","en"],correctIndex:1,explanation:"Canada بلد مذكر؛ لذلك نقول au Canada."},
 {prompt:"Ils viennent ___ Japon.",speech:"Quelle forme de la préposition de utilise-t-on avec Japon ?",instruction:"اختر الصيغة الصحيحة لذكر الأصل.",translation:"هم من اليابان.",choices:["de","des","du"],correctIndex:2,explanation:"Japon بلد مذكر؛ لذلك نقول du Japon."},
...
const A1_STUDIES_PRACTICE_ITEMS:Example[]=[
 ...
 {prompt:"J’___ le français.",speech:"Complétez la phrase. J’étudie le français.",instruction:"اختر الفعل المناسب للحديث عن الدراسة.",translation:"أدرس اللغة الفرنسية.",choices:["travaille","étudie","habite"],correctIndex:1,explanation:"نستعمل étudier للحديث عن المادة التي ندرسها."},
 {prompt:"Nous étudions ___ l’université.",speech:"Complétez la phrase. Nous étudions à l’université.",instruction:"اختر حرف الجر الصحيح مع مكان الدراسة.",translation:"نحن ندرس في الجامعة.",choices:["dans","à","comme"],correctIndex:1,explanation:"نقول étudier à l’université."},
 {prompt:"Mon cours ___ à neuf heures.",speech:"Complétez la phrase. Mon cours commence à neuf heures.",instruction:"اختر الفعل المناسب.",translation:"يبدأ درسي الساعة التاسعة.",choices:["commence","travaille","enseigne"],correctIndex:0,explanation:"commencer يعني يبدأ."},
 {prompt:"Elle est ___.",speech:"Elle est étudiante.",instruction:"اختر صيغة المؤنث الصحيحة.",translation:"هي طالبة.",choices:["étudiant","études","étudiante"],correctIndex:2,explanation:"étudiante هي صيغة المؤنث من étudiant."},
 {prompt:"Je suis ___ .",speech:"Je suis professeur.",instruction:"اختر الصياغة الصحيحة عند ذكر المهنة بعد être.",translation:"أنا معلّم.",choices:["un professeur","professeur","de professeur"],correctIndex:1,explanation:"بعد être نذكر المهنة عادة بلا أداة."},
 {prompt:"Nadia soigne les malades. Elle est ___.",speech:"Nadia soigne les malades. Elle est infirmière.",instruction:"اختر المهنة المناسبة.",translation:"نادية ممرضة.",choices:["vendeuse","infirmière","cuisinière"],correctIndex:1,explanation:"infirmière تعني ممرضة."},
 {prompt:"Mon frère prépare le pain. Il travaille dans une ___.",speech:"Mon frère prépare le pain. Il travaille dans une boulangerie.",instruction:"اختر مكان العمل المناسب.",translation:"أخي يجهّز الخبز. يعمل في مخبز.",choices:["boulangerie","bibliothèque","université"],correctIndex:0,explanation:"البولانجيري boulangerie هو المخبز."},
 {prompt:"Le cuisinier travaille dans un ___.",speech:"Le cuisinier travaille dans un restaurant.",instruction:"اختر مكان العمل المناسب للطاهي.",translation:"الطاهي يعمل في مطعم.",choices:["hôpital","restaurant","magasin"],correctIndex:1,explanation:"cuisinier يعمل في restaurant."},
 {prompt:"Qu’est-ce que tu ___ ?",speech:"Qu’est-ce que tu étudies ?",instruction:"أكمل السؤال غير الرسمي عن الدراسة.",translation:"ماذا تدرس؟",choices:["étudies","étudiez","étudions"],correctIndex:0,explanation:"مع tu نقول tu étudies."},
 {prompt:"Où ___-vous ?",speech:"Où travaillez-vous ?",instruction:"أكمل السؤال الرسمي عن مكان العمل.",translation:"أين تعملون؟",choices:["travaille","travaillez","travaillons"],correctIndex:1,explanation:"مع vous نقول travaillez-vous."},
 {prompt:"Quel est votre ___ ?",speech:"Quel est votre métier ?",instruction:"أكمل السؤال الرسمي عن المهنة.",translation:"ما مهنتكم؟",choices:["cours","métier","études"],correctIndex:1,explanation:"métier تعني المهنة."},
 {prompt:"Je m’appelle Adam. Je suis étudiant.",speech:"Je m’appelle Adam. Je suis étudiant.",instruction:"اختر الترجمة العربية الصحيحة.",choices:["اسمي آدم. أنا طالب.","اسمي آدم. أنا معلّم.","اسمي آدم. أنا طبيب."],correctIndex:0,explanation:"étudiant تعني طالب."},
 {prompt:"Ma sœur est vendeuse. Elle travaille dans un magasin.",speech:"Ma sœur est vendeuse. Elle travaille dans un magasin.",instruction:"اختر الترجمة العربية الصحيحة.",choices:["أختي طبيبة وتعمل في مستشفى.","أختي بائعة وتعمل في متجر.","أختي طالبة وتدرس في جامعة."],correctIndex:1,explanation:"vendeuse هي بائعة وmagasin هو متجر."},
 {prompt:"Il travaille ___ médecin.",speech:"Il travaille comme médecin.",instruction:"اختر الكلمة التي تسبق المهنة لوصف طبيعة العمل.",translation:"هو يعمل طبيبًا.",choices:["à","dans","comme"],correctIndex:2,explanation:"نستعمل comme قبل المهنة في عبارة travailler comme."},
 {prompt:"Mon père est médecin. Il travaille ___.",speech:"Mon père est médecin. Il travaille à l’hôpital.",instruction:"اختر مكان العمل المناسب.",translation:"والدي طبيب. يعمل في المستشفى.",choices:["à l’hôpital","au restaurant","à la bibliothèque"],correctIndex:0,explanation:"médecin يعمل عادة في hôpital."},
 {prompt:"Nous ___ les sciences.",speech:"Nous étudions les sciences.",instruction:"اختر تصريف étudier الصحيح مع nous.",translation:"نحن ندرس العلوم.",choices:["étudient","étudions","étudiez"],correctIndex:1,explanation:"مع nous نقول nous étudions."},
 {prompt:"Le professeur ___ le français.",speech:"Le professeur enseigne le français.",instruction:"اختر الفعل المناسب لعمل المعلّم.",translation:"المعلّم يدرّس الفرنسية.",choices:["enseigne","habite","commence"],correctIndex:0,explanation:"enseigner يعني يدرّس."},
 {prompt:"Elle travaille dans une école.",speech:"Elle travaille dans une école.",instruction:"اختر المعنى العربي الصحيح.",choices:["هي تعمل في مدرسة.","هي تدرس في مستشفى.","هي تعمل في مطعم."],correctIndex:0,explanation:"travailler dans une école تعني العمل في مدرسة."},
 {prompt:"Je suis photographe. Je travaille dans un studio.",speech:"Je suis photographe. Je travaille dans un studio.",instruction:"اختر الترجمة العربية الصحيحة.",choices:["أنا مصوّر. أعمل في استوديو.","أنا سائق. أعمل في مطار.","أنا طالب. أدرس في مكتبة."],correctIndex:0,explanation:"photographe تعني مصوّر وstudio تعني استوديو."},
 {prompt:"Elle est étudiante et elle étudie le français.",speech:"Elle est étudiante et elle étudie le français.",instruction:"اختر الجملة العربية المطابقة.",choices:["هي طالبة وتدرس الفرنسية.","هي معلّمة وتدرّس الفرنسية.","هي بائعة وتعمل في متجر."],correctIndex:0,explanation:"étudiante تعني طالبة وelle étudie تعني هي تدرس."}
];
...
const A1_TASTES_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"J’___ la musique.",speech:"J’aime la musique.",instruction:"اختر التصريف الصحيح.",translation:"أحب الموسيقى.",choices:["aime","aimes","aimons"],correctIndex:0,explanation:"مع je نقول j’aime."},
 {prompt:"Elle ___ lire.",speech:"Elle adore lire.",instruction:"اختر فعل الإعجاب القوي.",translation:"هي تعشق القراءة.",choices:["adore","adorons","adorez"],correctIndex:0,explanation:"adorer يعني يعشق."},
 {prompt:"Nous ___ le bruit.",speech:"Nous détestons le bruit.",instruction:"اختر التصريف مع nous.",translation:"نحن نكره الضوضاء.",choices:["détestent","détestons","détestez"],correctIndex:1,explanation:"مع nous نقول détestons."},
 {prompt:"Je ___ le thé au café.",speech:"Je préfère le thé au café.",instruction:"اختر فعل التفضيل.",translation:"أفضل الشاي على القهوة.",choices:["choisis","préfère","aime"],correctIndex:1,explanation:"نستعمل préférer لتفضيل خيار على آخر."},
 {prompt:"Tu ___ un film.",speech:"Tu choisis un film.",instruction:"اختر تصريف choisir.",translation:"أنت تختار فيلمًا.",choices:["choisit","choisis","choisissons"],correctIndex:1,explanation:"مع tu نقول choisis."},
 {prompt:"Il ___ le bus.",speech:"Il choisit le bus.",instruction:"اختر التصريف مع il.",translation:"هو يختار الحافلة.",choices:["choisis","choisit","choisissez"],correctIndex:1,explanation:"مع il تصبح النهاية -it."},
 {prompt:"Pourquoi préfères-tu marcher ?",speech:"Parce que c’est calme.",instruction:"اختر السبب المناسب.",translation:"لأنه هادئ.",choices:["Parce que c’est calme.","Je préfère le café.","Tu choisis un livre."],correctIndex:0,explanation:"نجيب عن pourquoi بـ parce que."},
 {prompt:"J’aime lire ___ regarder la télé.",speech:"J’aime lire plus que regarder la télé.",instruction:"اختر أداة المقارنة.",translation:"أحب القراءة أكثر من مشاهدة التلفاز.",choices:["au","plus que","parce que"],correctIndex:1,explanation:"مع aimer نستعمل plus que."},
 {prompt:"Je préfère le train ___ la voiture.",speech:"Je préfère le train à la voiture.",instruction:"اختر تركيب préférer.",translation:"أفضل القطار على السيارة.",choices:["plus que","à","parce que"],correctIndex:1,explanation:"مع préférer نستعمل à."},
...
const A1_DEMONSTRATIVES_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"___ stylo est à Paul.",speech:"Complétez la phrase. Ce stylo est à Paul.",instruction:"اختر صفة الإشارة المناسبة.",translation:"هذا القلم لبول.",choices:["Ce","Cet","Cette"],correctIndex:0,explanation:"stylo مذكر مفرد ويبدأ بصوت ساكن؛ لذلك نستخدم ce."},
 {prompt:"___ jardin est derrière la maison.",speech:"Complétez la phrase. Ce jardin est derrière la maison.",instruction:"اختر الصيغة المناسبة.",translation:"هذه الحديقة خلف المنزل.",choices:["Ces","Ce","Cette"],correctIndex:1,explanation:"jardin مذكر مفرد ويبدأ بصوت ساكن؛ لذلك نستخدم ce."},
 {prompt:"___ ami est très gentil.",speech:"Complétez la phrase. Cet ami est très gentil.",instruction:"اختر الصيغة المناسبة قبل صوت متحرك.",translation:"هذا الصديق لطيف جدًا.",choices:["Ce","Cet","Ces"],correctIndex:1,explanation:"ami مذكر مفرد ويبدأ بصوت متحرك؛ لذلك نستخدم cet."},
 {prompt:"___ hôtel est près de la gare.",speech:"Complétez la phrase. Cet hôtel est près de la gare.",instruction:"اختر الصيغة المناسبة مع h صامت.",translation:"هذا الفندق قريب من المحطة.",choices:["Cette","Cet","Ce"],correctIndex:1,explanation:"hôtel مذكر ويبدأ بـ h صامت؛ لذلك نستخدم cet."},
 {prompt:"___ ordinateur est neuf.",speech:"Complétez la phrase. Cet ordinateur est neuf.",instruction:"اختر الصيغة الصحيحة.",translation:"هذا الحاسوب جديد.",choices:["Cet","Ce","Cette"],correctIndex:0,explanation:"ordinateur مذكر مفرد ويبدأ بصوت متحرك؛ لذلك نستخدم cet."},
 {prompt:"___ clé ouvre la porte.",speech:"Complétez la phrase. Cette clé ouvre la porte.",instruction:"اختر الصيغة المناسبة للاسم المؤنث.",translation:"هذا المفتاح يفتح الباب.",choices:["Cette","Cet","Ces"],correctIndex:0,explanation:"clé مؤنث مفرد؛ لذلك نستخدم cette."},
 {prompt:"___ école est près d’ici.",speech:"Complétez la phrase. Cette école est près d’ici.",instruction:"اختر صفة الإشارة الصحيحة.",translation:"هذه المدرسة قريبة من هنا.",choices:["Cet","Cette","Ce"],correctIndex:1,explanation:"école مؤنث، لذلك تبقى cette حتى مع بداية صوت متحرك."},
 {prompt:"___ rue est calme.",speech:"Complétez la phrase. Cette rue est calme.",instruction:"اختر الصيغة المناسبة.",translation:"هذا الشارع هادئ.",choices:["Ces","Cette","Cet"],correctIndex:1,explanation:"rue مؤنث مفرد؛ لذلك نستخدم cette."},
 {prompt:"___ voisins arrivent ce soir.",speech:"Complétez la phrase. Ces voisins arrivent ce soir.",instruction:"اختر صيغة الجمع.",translation:"هؤلاء الجيران يصلون هذا المساء.",choices:["Ce","Cette","Ces"],correctIndex:2,explanation:"voisins جمع؛ لذلك نستخدم ces."},
 {prompt:"___ oranges sont bonnes.",speech:"Complétez la phrase. Ces oranges sont bonnes.",instruction:"اختر الصيغة المناسبة.",translation:"هذه البرتقالات لذيذة.",choices:["Ces","Cet","Cette"],correctIndex:0,explanation:"oranges جمع مؤنث، وصيغة الجمع للمذكر والمؤنث هي ces."},
 {prompt:"Je prends ___ bus.",speech:"Je prends ce bus.",instruction:"أكمل الجملة بصفة الإشارة الصحيحة.",translation:"آخذ هذه الحافلة.",choices:["ce","cet","cette"],correctIndex:0,explanation:"bus مذكر مفرد ويبدأ بصوت ساكن؛ لذلك نستخدم ce."},
 {prompt:"Nous visitons ___ ancien musée.",speech:"Nous visitons cet ancien musée.",instruction:"اختر الصيغة المناسبة قبل الصفة.",translation:"نزور هذا المتحف القديم.",choices:["ce","cet","ces"],correctIndex:1,explanation:"ancien مذكر ويبدأ بصوت متحرك؛ لذلك نستخدم cet."}
];
...
const A1_NOUNS_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"C’est ___ livre.",translation:"هذا كتاب.",speech:"Quel article indéfini faut-il placer devant livre ?",instruction:"اختر أداة النكرة المناسبة لاسم مذكر مفرد.",choices:["une","un","des"],correctIndex:1,explanation:"livre مذكر مفرد؛ لذلك نقول un livre."},
 {prompt:"Voilà ___ chaise.",translation:"هذا كرسي.",speech:"Quel article indéfini faut-il placer devant chaise ?",instruction:"اختر أداة النكرة المناسبة لاسم مؤنث مفرد.",choices:["une","un","des"],correctIndex:0,explanation:"chaise مؤنث مفرد؛ لذلك نقول une chaise."},
 {prompt:"___ école est près d’ici.",translation:"المدرسة قريبة من هنا.",speech:"Quel article défini faut-il placer devant école ?",instruction:"اختر أداة المعرفة قبل اسم يبدأ بصوت متحرك.",choices:["La","Le","L’"],correctIndex:2,explanation:"école مؤنث ويبدأ بصوت متحرك؛ لذلك نقول l’école."},
 {prompt:"Il y a ___ pommes dans le panier.",translation:"يوجد تفاح في السلة.",speech:"Quel article indéfini faut-il placer devant pommes ?",instruction:"اختر أداة التنكير المناسبة للجمع.",choices:["des","une","un"],correctIndex:0,explanation:"pommes جمع غير معرّف؛ لذلك نقول des pommes."},
 {prompt:"J’ai trois crayons. ___ crayons sont neufs.",translation:"لديّ ثلاثة أقلام رصاص. الأقلام جديدة.",speech:"Quel article défini faut-il placer devant crayons ?",instruction:"اختر أداة المعرفة بعد ذكر الأقلام.",choices:["Le","Les","La"],correctIndex:1,explanation:"crayons جمع معروف بعد ذكره؛ لذلك نقول les crayons."},
 {prompt:"Un étudiant, deux ___.",translation:"طالب واحد، طالبان.",speech:"Quel est le pluriel du mot étudiant ?",instruction:"اختر صيغة جمع étudiant.",choices:["étudiantes","étudiants","étudiant"],correctIndex:1,explanation:"جمع étudiant هو étudiants بإضافة s."},
 {prompt:"Un journal, des ___.",translation:"صحيفة واحدة، صحف.",speech:"Quel est le pluriel du mot journal ?",instruction:"اختر صيغة جمع journal.",choices:["journals","journales","journaux"],correctIndex:2,explanation:"تتحول نهاية -al في journal إلى -aux: journaux."},
 {prompt:"Un château, des ___.",translation:"قلعة واحدة، قلاع.",speech:"Quel est le pluriel du mot château ?",instruction:"اختر صيغة جمع château.",choices:["châteaux","châteaus","châtals"],correctIndex:0,explanation:"تأخذ نهاية -eau حرف x في الجمع: châteaux."},
 {prompt:"Un prix, plusieurs ___.",translation:"سعر واحد، عدة أسعار.",speech:"Quel est le pluriel du mot prix ?",instruction:"اختر صيغة جمع prix.",choices:["prises","prixs","prix"],correctIndex:2,explanation:"prix ينتهي أصلًا بـ x؛ لذلك لا تتغير كتابته في الجمع."},
 {prompt:"Quel est le féminin du nom « boulanger » ?",translation:"ما صيغة المؤنث لاسم المهنة «boulanger»؟",speech:"Quel est le féminin du nom boulanger ?",instruction:"اختر صيغة المؤنث مع أداة التعريف.",choices:["la boulangère","la boulanger","la boulangeuse"],correctIndex:0,explanation:"مؤنث boulanger هو boulangère؛ فنقول la boulangère."},
 {prompt:"___ musée ferme à dix-huit heures.",translation:"يغلق المتحف الساعة السادسة مساءً.",speech:"Quel article défini faut-il placer devant musée ?",instruction:"اختر أداة المعرفة للاسم المذكر.",choices:["Le","La","Une"],correctIndex:0,explanation:"musée مذكر مفرد؛ لذلك نقول le musée."},
 {prompt:"___ porte est ouverte.",translation:"الباب مفتوح.",speech:"Quel article défini faut-il placer devant porte ?",instruction:"اختر أداة المعرفة للاسم المؤنث.",choices:["Un","La","Les"],correctIndex:1,explanation:"porte مؤنث مفرد في الفرنسية؛ لذلك نقول la porte."},
 {prompt:"Nous visitons ___ appartement lumineux.",translation:"نزور شقة مضيئة.",speech:"Quel article indéfini faut-il placer devant appartement ?",instruction:"اختر أداة النكرة للاسم المذكر.",choices:["une","des","un"],correctIndex:2,explanation:"appartement مذكر مفرد؛ لذلك نقول un appartement."},
 {prompt:"Elle prépare ___ salade verte.",translation:"تحضّر سلطة خضراء.",speech:"Quel article indéfini faut-il placer devant salade ?",instruction:"اختر أداة النكرة للاسم المؤنث.",choices:["une","un","des"],correctIndex:0,explanation:"salade مؤنث مفرد؛ لذلك نقول une salade."},
 {prompt:"___ hôtel est complet.",translation:"الفندق مكتمل الحجز.",speech:"Quel article défini faut-il placer devant hôtel ?",instruction:"اختر أداة المعرفة قبل h غير منطوقة.",choices:["Le","L’","La"],correctIndex:1,explanation:"h في hôtel غير منطوقة؛ لذلك تختصر le إلى l’."},
 {prompt:"Un festival, des ___.",translation:"مهرجان واحد، مهرجانات.",speech:"Quel est le pluriel du mot festival ?",instruction:"اختر صيغة جمع festival.",choices:["festivaux","festivals","festivales"],correctIndex:1,explanation:"festival استثناء من قاعدة -al؛ جمعه festivals."},
 {prompt:"Je bois ___ lait.",translation:"أشرب حليبًا.",speech:"Quel article partitif faut-il placer devant lait ?",instruction:"اختر أداة التجزئة المناسبة للاسم المذكر.",choices:["du","de la","des"],correctIndex:0,explanation:"lait مذكر؛ نستعمل du للتعبير عن كمية غير محددة."},
 {prompt:"Nous préparons ___ soupe.",translation:"نحضّر حساءً.",speech:"Quel article partitif faut-il placer devant soupe ?",instruction:"اختر أداة التجزئة المناسبة للاسم المؤنث.",choices:["du","de la","des"],correctIndex:1,explanation:"soupe مؤنث؛ نستعمل de la للتعبير عن كمية غير محددة."},
 {prompt:"Elle boit ___ eau.",translation:"تشرب ماءً.",speech:"Quel article partitif faut-il placer devant eau ?",instruction:"اختر أداة التجزئة قبل اسم يبدأ بصوت متحرك.",choices:["du","de la","de l’"],correctIndex:2,explanation:"eau يبدأ بصوت متحرك؛ لذلك نقول de l’eau."},
 {prompt:"Je n’ai pas ___ sucre.",translation:"ليس لديّ سكر.",speech:"Quel mot faut-il placer devant sucre après la négation ?",instruction:"اختر الصيغة بعد نفي كمية غير محددة.",choices:["du","de","des"],correctIndex:1,explanation:"في النفي تتحول أداة التجزئة du إلى de: pas de sucre."}
];
...
const A1_CORE_VERBS_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"Je ___ à la gare.",translation:"أنا في المحطة.",speech:"Quelle est la forme du verbe être avec je ?",instruction:"اختر تصريف être المناسب.",choices:["suis","ai","es"],correctIndex:0,explanation:"مع je نقول je suis للمكان."},
 {prompt:"Tu ___ à la maison.",translation:"أنت في المنزل.",speech:"Quelle est la forme du verbe être avec tu ?",instruction:"اختر تصريف être المناسب.",choices:["est","es","as"],correctIndex:1,explanation:"مع tu نقول tu es."},
 {prompt:"Elle ___ médecin.",translation:"هي طبيبة.",speech:"Quelle est la forme du verbe être avec elle ?",instruction:"اختر تصريف être المناسب.",choices:["a","sont","est"],correctIndex:2,explanation:"مع elle نقول elle est للمهنة دون أداة تعريف."},
 {prompt:"On ___ en classe.",translation:"نحن في الصف.",speech:"Quelle est la forme du verbe être avec on ?",instruction:"اختر تصريف être المناسب.",choices:["est","a","sommes"],correctIndex:0,explanation:"مع on نقول on est، حتى عندما تعني «نحن»."},
 {prompt:"Nous ___ voisins.",translation:"نحن جيران.",speech:"Quelle est la forme du verbe être avec nous ?",instruction:"اختر تصريف être المناسب.",choices:["avons","sommes","êtes"],correctIndex:1,explanation:"مع nous نقول nous sommes."},
 {prompt:"Vous ___ en retard.",translation:"أنتم متأخرون.",speech:"Quelle est la forme du verbe être avec vous ?",instruction:"اختر تصريف être المناسب.",choices:["avez","sont","êtes"],correctIndex:2,explanation:"مع vous نقول vous êtes."},
 {prompt:"Ils ___ au parc.",translation:"هم في الحديقة.",speech:"Quelle est la forme du verbe être avec ils ?",instruction:"اختر تصريف être المناسب.",choices:["sont","ont","est"],correctIndex:0,explanation:"مع ils نقول ils sont."},
 {prompt:"J’___ un billet.",translation:"لديّ تذكرة.",speech:"Quelle est la forme du verbe avoir avec je ?",instruction:"اختر تصريف avoir المناسب.",choices:["suis","ai","as"],correctIndex:1,explanation:"قبل صوت متحرك تصبح je: j’، فنقول j’ai."},
 {prompt:"Tu ___ deux livres.",translation:"لديك كتابان.",speech:"Quelle est la forme du verbe avoir avec tu ?",instruction:"اختر تصريف avoir المناسب.",choices:["es","a","as"],correctIndex:2,explanation:"مع tu نقول tu as."},
 {prompt:"Il ___ vingt ans.",translation:"عمره عشرون عامًا.",speech:"Quelle est la forme du verbe avoir avec il ?",instruction:"اختر تصريف avoir المناسب للتعبير عن العمر.",choices:["a","est","ont"],correctIndex:0,explanation:"نستعمل avoir للعمر: il a vingt ans."},
 {prompt:"Elle ___ faim.",translation:"هي جائعة.",speech:"Quelle est la forme du verbe avoir avec elle ?",instruction:"اختر تصريف avoir المناسب للتعبير عن الجوع.",choices:["est","a","as"],correctIndex:1,explanation:"نستعمل avoir للتعبير عن الجوع: elle a faim."},
 {prompt:"Nous ___ une question.",translation:"لدينا سؤال.",speech:"Quelle est la forme du verbe avoir avec nous ?",instruction:"اختر تصريف avoir المناسب.",choices:["sommes","avez","avons"],correctIndex:2,explanation:"مع nous نقول nous avons."},
 {prompt:"Vous ___ un rendez-vous.",translation:"لديكم موعد.",speech:"Quelle est la forme du verbe avoir avec vous ?",instruction:"اختر تصريف avoir المناسب.",choices:["avez","êtes","avons"],correctIndex:0,explanation:"مع vous نقول vous avez."},
 {prompt:"Elles ___ soif.",translation:"هنّ عطشى.",speech:"Quelle est la forme du verbe avoir avec elles ?",instruction:"اختر تصريف avoir المناسب للتعبير عن العطش.",choices:["sont","ont","a"],correctIndex:1,explanation:"نستعمل avoir للتعبير عن العطش: elles ont soif."},
 {prompt:"___ suis prêt.",translation:"أنا مستعد.",speech:"Quel pronom va avec suis ?",instruction:"اختر ضمير الفاعل المناسب.",choices:["Je","Tu","Il"],correctIndex:0,explanation:"suis هو تصريف être مع je."},
 {prompt:"___ est à l’école.",translation:"هي في المدرسة.",speech:"Quel pronom sujet faut-il choisir ?",instruction:"اختر ضمير الفاعل المؤنث المفرد.",choices:["Ils","Elle","Nous"],correctIndex:1,explanation:"elle ضمير المفرد المؤنث، ويأتي معه est."},
 {prompt:"___ sommes ici.",translation:"نحن هنا.",speech:"Quel pronom va avec sommes ?",instruction:"اختر ضمير الفاعل المناسب.",choices:["Vous","On","Nous"],correctIndex:2,explanation:"sommes هو تصريف être مع nous."},
 {prompt:"___ ont un chien.",translation:"لديهن كلب.",speech:"Quel pronom sujet faut-il choisir ?",instruction:"اختر ضمير الفاعل للجمع المؤنث.",choices:["Elle","Elles","Nous"],correctIndex:1,explanation:"elles ضمير الجمع المؤنث، ويأتي معه ont."},
 {prompt:"Quelle phrase exprime la faim ?",translation:"أي جملة تعبّر عن الجوع؟",speech:"Quelle phrase exprime la faim ?",instruction:"اختر الجملة المناسبة.",choices:["Je suis prêt.","J’ai faim.","J’ai froid."],correctIndex:1,explanation:"في الفرنسية نعبّر عن الجوع بعبارة avoir faim."},
...
const A1_PRESENT_QUIZ_ITEMS:QuizQuestion[]=[
 ...
 {prompt:"Je ___ achète pas ___ pain.",translation:"أنا لا أشتري خبزًا.",speech:"Je n’achète pas de pain.",instruction:"اختر الصيغة الصحيحة قبل الفعل المبدوء بحرف متحرك وبعد النفي.",choices:["n’ … de","ne … du","n’ … du"],correctIndex:0,explanation:"تصبح ne هي n’ قبل achète، وبعد النفي نقول de pain."},
 ...
 {prompt:"Ce ___ pas un livre.",translation:"هذا ليس كتابًا.",speech:"Ce n’est pas un livre.",instruction:"اختر تصريف être الصحيح في النفي.",choices:["n’est","n’êtes","ne sont"],correctIndex:0,explanation:"مع ce نقول c’est؛ وفي النفي نقول ce n’est pas. تبقى الأداة un مع être."},
...
const A1_HOME_HOUSING_QUIZ_ITEMS:QuizQuestion[]=[
 {prompt:"J’___ dans un appartement.",translation:"أسكن في شقة.",speech:"J’habite dans un appartement.",instruction:"اختر الفعل المناسب.",choices:["habite","porte","tourne"],correctIndex:0,explanation:"habiter يعني يسكن."},
 {prompt:"Il y a un lit dans la ___.",translation:"يوجد سرير في غرفة النوم.",speech:"Il y a un lit dans la chambre.",instruction:"اختر اسم الغرفة المناسب.",choices:["cuisine","chambre","salle de bains"],correctIndex:1,explanation:"يوجد السرير عادةً في chambre."},
 {prompt:"Nous préparons le repas dans la ___.",translation:"نحضّر الطعام في المطبخ.",speech:"Nous préparons le repas dans la cuisine.",instruction:"اختر اسم الغرفة المناسب.",choices:["cuisine","chambre","balcon"],correctIndex:0,explanation:"نحضّر الطعام في cuisine."},
 {prompt:"Le livre est ___ la table.",translation:"الكتاب فوق الطاولة.",speech:"Le livre est sur la table.",instruction:"اختر حرف المكان الصحيح.",choices:["sous","dans","sur"],correctIndex:2,explanation:"sur تعني فوق أو على."},
 {prompt:"Les chaussures sont ___ le lit.",translation:"الأحذية تحت السرير.",speech:"Les chaussures sont sous le lit.",instruction:"اختر حرف المكان الصحيح.",choices:["devant","sous","entre"],correctIndex:1,explanation:"sous تعني تحت."},
 {prompt:"La table est ___ les deux chaises.",translation:"الطاولة بين الكرسيين.",speech:"La table est entre les deux chaises.",instruction:"اختر حرف المكان الصحيح.",choices:["entre","derrière","sur"],correctIndex:0,explanation:"entre تعني بين."},
 {prompt:"L’armoire est en face ___ lit.",translation:"الخزانة مقابل السرير.",speech:"L’armoire est en face du lit.",instruction:"اختر الشكل الصحيح بعد en face de.",choices:["au","du","le"],correctIndex:1,explanation:"de مع le تندمج لتصبح du."},
 {prompt:"J’habite ___ deuxième étage.",translation:"أسكن في الطابق الثاني.",speech:"J’habite au deuxième étage.",instruction:"اختر الصيغة الصحيحة مع الطابق.",choices:["du","aux","au"],correctIndex:2,explanation:"نقول au deuxième étage."},
 {prompt:"L’appartement est petit, ___ lumineux.",translation:"الشقة صغيرة لكنها مضيئة.",speech:"L’appartement est petit, mais lumineux.",instruction:"اختر الرابط المناسب.",choices:["mais","ou","parce que"],correctIndex:0,explanation:"mais تعني لكن."},
 {prompt:"Ma pièce préférée est le salon.",translation:"غرفتي المفضلة هي غرفة الجلوس.",speech:"Ma pièce préférée est le salon.",instruction:"اختر المعنى العربي الصحيح.",choices:["غرفة نومي بجوار الصالة.","غرفتي المفضلة هي غرفة الجلوس.","منزلي لا يحتوي على غرفة جلوس."],correctIndex:1,explanation:"la pièce préférée تعني الغرفة المفضلة."},
 {prompt:"La voiture est ___ le garage.",translation:"السيارة داخل المرآب.",speech:"La voiture est dans le garage.",instruction:"اختر حرف المكان المناسب.",choices:["dans","sur","entre"],correctIndex:0,explanation:"dans تعني داخل."},
 {prompt:"Le canapé est ___ la fenêtre.",translation:"الأريكة أمام النافذة.",speech:"Le canapé est devant la fenêtre.",instruction:"اختر كلمة المكان المناسبة.",choices:["sous","devant","dans"],correctIndex:1,explanation:"devant تعني أمام."},
 {prompt:"Le jardin est ___ la maison.",translation:"الحديقة خلف المنزل.",speech:"Le jardin est derrière la maison.",instruction:"اختر كلمة المكان المناسبة.",choices:["sur","entre","derrière"],correctIndex:2,explanation:"derrière تعني خلف."},
 {prompt:"Il y a une douche dans la ___.",translation:"يوجد دش في الحمام.",speech:"Il y a une douche dans la salle de bains.",instruction:"اختر الغرفة المناسبة.",choices:["salle de bains","salle à manger","chambre"],correctIndex:0,explanation:"توجد douche في salle de bains."},
 {prompt:"Nous dînons dans la ___.",translation:"نتناول العشاء في غرفة الطعام.",speech:"Nous dînons dans la salle à manger.",instruction:"اختر الغرفة المناسبة.",choices:["cave","salle à manger","entrée"],correctIndex:1,explanation:"salle à manger هي غرفة الطعام."},
 {prompt:"Mon appartement a un petit ___.",translation:"في شقتي شرفة صغيرة.",speech:"Mon appartement a un petit balcon.",instruction:"اختر الجزء المناسب من المسكن.",choices:["cuisine","toit","balcon"],correctIndex:2,explanation:"balcon تعني شرفة."},
 {prompt:"Nous habitons ___ 18, rue Victor-Hugo.",translation:"نسكن في 18 شارع فيكتور هوغو.",speech:"Nous habitons au 18, rue Victor-Hugo.",instruction:"اختر الصيغة الصحيحة قبل رقم العنوان.",choices:["au","en","du"],correctIndex:0,explanation:"نستخدم au قبل رقم العنوان."},
 {prompt:"Combien de chambres ___-t-il ?",translation:"كم غرفة نوم توجد؟",speech:"Combien de chambres y a-t-il ?",instruction:"أكمل السؤال الصحيح.",choices:["est","y a","habite"],correctIndex:1,explanation:"صيغة السؤال عن الموجود هي y a-t-il."},
 {prompt:"La maison est grande ___ confortable.",translation:"المنزل كبير ومريح.",speech:"La maison est grande et confortable.",instruction:"اختر رابط الجمع.",choices:["mais","parce que","et"],correctIndex:2,explanation:"et تعني و وتجمع صفتين."},
 {prompt:"Le loyer est de six cents euros par mois.",translation:"الإيجار ستمئة يورو شهريًا.",speech:"Le loyer est de six cents euros par mois.",instruction:"اختر المعنى العربي الصحيح.",choices:["الإيجار ستمئة يورو شهريًا.","الشقة في الطابق السادس.","المنزل يضم ست غرف."],correctIndex:0,explanation:"loyer هو الإيجار وpar mois تعني شهريًا."}
];
...
const A1_GREETINGS_LISTENING={
 title:"Les salutations et la présentation",
 arTitle:"التحيات والتعريف بالنفس",
 text:A1_GREETINGS_LISTENING_CLIPS.map(clip=>clip.hiddenSpeech).join(" "),
 questions:[
  {prompt:"Quelle salutation entendez-vous ?",translation:"أي تحية تسمع؟",choices:["Bonjour, monsieur.","Bonsoir, monsieur.","Salut, monsieur."],correctIndex:0},
  {prompt:"Quand est-ce qu’on utilise cette salutation ?",translation:"متى نستخدم هذه التحية؟",choices:["Le matin","Le soir","À midi"],correctIndex:1},
  {prompt:"À qui dit-on cette salutation ?",translation:"لمن نقول هذه التحية؟",choices:["À un ami","À un inconnu","À un directeur"],correctIndex:0},
  {prompt:"Quel mot entendez-vous dans cette question ?",translation:"أي كلمة تسمع في هذا السؤال؟",choices:["tu","je","vous"],correctIndex:2},
  {prompt:"Quelle est la bonne réponse ?",translation:"ما الإجابة المناسبة؟",choices:["Je suis Omar.","Oui, ça va, merci.","Au revoir."],correctIndex:1},
  {prompt:"Comment va la personne ?",translation:"كيف حال المتحدث؟",choices:["La personne va mal.","La personne va bien.","La personne habite à Lyon."],correctIndex:1},
  {prompt:"Quelle information donne la personne ?",translation:"ما المعلومة التي يذكرها المتحدث؟",choices:["Son pays","Sa ville","Son prénom"],correctIndex:2},
  {prompt:"Quel prénom entendez-vous ?",translation:"أي اسم تسمع؟",choices:["Omar","Adam","Karim"],correctIndex:1},
  {prompt:"De quel pays vient la personne ?",translation:"من أي بلد المتحدث؟",choices:["La France","Le Maroc","L’Italie"],correctIndex:1},
  {prompt:"Où habite la personne ?",translation:"أين يسكن المتحدث؟",choices:["À Marseille","À Lyon","À Paris"],correctIndex:1},
  {prompt:"Quelles langues parle la personne ?",translation:"ما اللغات التي يتحدثها؟",choices:["Le français seulement","L’arabe et l’anglais","L’arabe et un peu de français"],correctIndex:2},
  {prompt:"Quand dit-on cette phrase ?",translation:"متى نقول هذه العبارة؟",choices:["Quand on arrive","Quand on part","Quand on demande un prénom"],correctIndex:1},
  {prompt:"Que veut dire cette phrase ?",translation:"ماذا تعني هذه العبارة؟",choices:["Bonjour","Merci","On se voit bientôt"],correctIndex:2}
 ]
};
...
const A1_GREETINGS_WRITING_TRANSLATIONS=[
 {fr:"bonjour",ar:"مرحبًا / صباح الخير"},{fr:"bonsoir",ar:"مساء الخير"},{fr:"salut",ar:"أهلًا"},{fr:"je m’appelle",ar:"اسمي"},
 {fr:"enchanté",ar:"تشرفت"},{fr:"bienvenue",ar:"أهلًا وسهلًا"},{fr:"au revoir",ar:"إلى اللقاء"},{fr:"à bientôt",ar:"إلى لقاء قريب"}
];
...
const A1_COUNTRIES_BUILDERS=[
 {tokens:["viens","Je","saoudite.","d’Arabie"],answer:["Je","viens","d’Arabie","saoudite."],ar:"أنا من المملكة العربية السعودية.",explanationAr:"بعد venir نستخدم d’ قبل Arabie saoudite لأنها تبدأ بصوت متحرك.",explanationFr:"On dit venir d’Arabie saoudite."},
 {tokens:["France.","habite","en","Elle"],answer:["Elle","habite","en","France."],ar:"هي تسكن في فرنسا.",explanationAr:"نستخدم en مع France للتعبير عن مكان السكن.",explanationFr:"On dit habiter en France."},
 {tokens:["est","Mon","marocain.","ami"],answer:["Mon","ami","est","marocain."],ar:"صديقي مغربي.",explanationAr:"تأتي الجنسية بعد être، وهنا نستعمل صيغة المذكّر marocain.",explanationFr:"Avec mon ami, on emploie le masculin marocain."},
 {tokens:["parlons","Nous","français.","arabe","et"],answer:["Nous","parlons","arabe","et","français."],ar:"نتحدث العربية والفرنسية.",explanationAr:"بعد parler نذكر اللغتين دون أداة تعريف.",explanationFr:"Après parler, on nomme les langues sans article."},
 {tokens:["langue","Quelle","parlez-vous ?"],answer:["Quelle","langue","parlez-vous ?"],ar:"ما اللغة التي تتحدثون بها؟",explanationAr:"نستخدم Quelle لأن langue اسم مؤنث، ثم نكمل السؤال بـ parlez-vous.",explanationFr:"Quelle s’accorde avec langue, un nom féminin."},
 {tokens:["portugais.","J’apprends","le"],answer:["J’apprends","le","portugais."],ar:"أتعلم البرتغالية.",explanationAr:"بعد apprendre نستعمل أداة التعريف مع اسم اللغة: le portugais.",explanationFr:"On dit apprendre le portugais, avec l’article défini."}
];
...
const A1_NOUNS_BUILDERS=[
 {tokens:["vélo.","un","C’est"],answer:["C’est","un","vélo."],ar:"هذه دراجة.",explanationAr:"vélo اسم مذكر مفرد غير محدد؛ لذلك نستخدم un.",explanationFr:"« Vélo » est masculin singulier et indéfini : on emploie « un »."},
 {tokens:["pomme.","une","Voici"],answer:["Voici","une","pomme."],ar:"هذه تفاحة.",explanationAr:"pomme اسم مؤنث مفرد غير محدد؛ لذلك نستخدم une.",explanationFr:"« Pomme » est féminin singulier et indéfini : on emploie « une »."},
 {tokens:["ici.","est","L’école"],answer:["L’école","est","ici."],ar:"المدرسة هنا.",explanationAr:"تُختصر la إلى l’ قبل école لأنها تبدأ بصوت متحرك.",explanationFr:"Devant « école », « la » devient « l’ » à cause de la voyelle initiale."},
 {tokens:["lait.","du","bois","Je"],answer:["Je","bois","du","lait."],ar:"أشرب حليبًا.",explanationAr:"نستخدم du قبل lait للتعبير عن كمية غير محددة من الحليب.",explanationFr:"« Du » exprime une quantité indéfinie de lait."},
 {tokens:["de","soupe.","mange","Elle","la"],answer:["Elle","mange","de","la","soupe."],ar:"هي تأكل حساءً.",explanationAr:"نستخدم de la قبل soupe لأنها اسم مؤنث مفرد يدل هنا على كمية غير محددة.",explanationFr:"« De la » s’emploie devant « soupe », nom féminin, pour une quantité indéfinie."},
 {tokens:["jardin.","chiens","dans","Les","sont","le"],answer:["Les","chiens","sont","dans","le","jardin."],ar:"الكلاب في الحديقة.",explanationAr:"les أداة تعريف للجمع، وأُضيفت s إلى chien عند جمعه.",explanationFr:"« Les » est l’article défini pluriel ; « chien » prend un s au pluriel."},
 {tokens:["livres.","J’ai","des"],answer:["J’ai","des","livres."],ar:"لديّ كتب.",explanationAr:"des أداة تنكير للجمع، وأُضيفت s إلى livre.",explanationFr:"« Des » est l’article indéfini pluriel ; « livre » prend un s."},
 {tokens:["chevaux.","des","Voici"],answer:["Voici","des","chevaux."],ar:"هذه خيول.",explanationAr:"جمع cheval هو chevaux؛ تتحول النهاية -al إلى -aux.",explanationFr:"Le pluriel de « cheval » est « chevaux » : -al devient -aux."},
 {tokens:["ici.","sont","souris","Les"],answer:["Les","souris","sont","ici."],ar:"الفئران هنا.",explanationAr:"تبقى كتابة souris كما هي في الجمع لأنها تنتهي بـ s، وتتغير الأداة إلى les.",explanationFr:"« Souris » ne change pas au pluriel ; l’article devient « les »."},
 {tokens:["bas.","prix","Les","sont"],answer:["Les","prix","sont","bas."],ar:"الأسعار منخفضة.",explanationAr:"تبقى كتابة prix كما هي في الجمع لأنها تنتهي بـ x، ونستخدم معها les.",explanationFr:"« Prix » ne change pas au pluriel ; on emploie « les »."}
];

const A1_NOUNS_DIALOGUES=[
 {context:"Qu’est-ce qu’il y a dans ton sac ?",translation:"ماذا يوجد في حقيبتك؟",prompt:"اختر الرد المناسب.",choices:["Je suis à la maison.","Il y a un livre.","Le sac est bleu."],correctIndex:1,feedback:"السؤال عن شيء داخل الحقيبة؛ un livre يعني كتابًا غير محدد."},
 {context:"Tu as une bouteille d’eau ?",translation:"هل لديك زجاجة ماء؟",prompt:"اختر الرد المناسب.",choices:["Oui, j’ai une bouteille d’eau.","Je travaille à l’école.","Le train est ici."],correctIndex:0,feedback:"الرد يجيب عن السؤال مباشرة؛ bouteille اسم مؤنث تسبقه une."},
 {context:"Où est la clé ?",translation:"أين المفتاح؟",prompt:"اختر الرد المناسب.",choices:["Je bois de l’eau.","La clé est sur la table.","Ce sont des clés."],correctIndex:1,feedback:"السؤال عن مكان مفتاح محدد؛ لذلك يذكر الرد la clé ومكانها."},
 {context:"Où sont les cahiers ?",translation:"أين الدفاتر؟",prompt:"اختر الرد المناسب.",choices:["Les cahiers sont dans le sac.","Le cahier est bleu.","Je veux du lait."],correctIndex:0,feedback:"السؤال عن دفاتر بصيغة الجمع؛ les cahiers يطابقها ويحدد مكانها."},
 {context:"Tu veux du lait ?",translation:"هل تريد حليبًا؟",prompt:"اختر الرد المناسب.",choices:["J’ai des livres.","Oui, je veux du lait.","La clé est ici."],correctIndex:1,feedback:"du lait تعبر عن كمية غير محددة من الحليب، والرد يجيب بنعم."},
 {context:"Tu veux de la soupe ?",translation:"هل تريد حساءً؟",prompt:"اختر الرد المناسب.",choices:["Oui, je voudrais de la soupe.","Je suis en France.","Les livres sont ici."],correctIndex:0,feedback:"de la soupe صيغة صحيحة مع الاسم المؤنث soupe، والرد يقبل العرض."},
 {context:"Qu’est-ce que tu bois ?",translation:"ماذا تشرب؟",prompt:"اختر الرد المناسب.",choices:["Je bois de l’eau.","Il y a de la salade.","Un cheval est dans le jardin."],correctIndex:0,feedback:"الرد يذكر ما يُشرب؛ نستخدم de l’ قبل eau التي تبدأ بصوت متحرك."},
...
const A1_STUDIES_LEARNING_GROUPS:{branches:{fr:string;ar:string;note:string;examples:Example[]}[]}[]=[
 {branches:[
  ...
  {fr:"Les verbes d’étude",ar:"أفعال الدراسة",note:"نتعلّم أفعال الدراسة الأساسية مثل étudier وapprendre وlire وécrire مع أمثلة قصيرة مناسبة لمستوى A1.",examples:[]}
 ]},
 {branches:[
...
const A1_NOUNS_LEARNING_GROUPS=[
 ...
 {branches:[
  ...
  {fr:"Les pluriels fréquents en -aux",ar:"صيغ جمع شائعة بـ -aux",note:"تتحول -al غالبًا إلى -aux، ونضيف x إلى الأسماء المنتهية بـ -au أو -eau. توجد استثناءات مثل festival التي تجمع بإضافة s.",examples:[]},
  {fr:"Les articles au pluriel",ar:"الأدوات مع الجمع",note:"في الجمع تتحول أدوات التعريف le وla وl’ إلى les، وتتحول أداتا التنكير un وune إلى des. يتغير الاسم أيضًا حسب قاعدة جمعه.",examples:[]}
 ]}
];
...
const A1_INDEFINITE_ARTICLE_CARDS=[
...
const A1_REGULAR_PLURAL_EXAMPLES=[
 {singular:"un poisson",singularAr:"سمكة",plural:"des poissons",pluralAr:"أسماك"},
 {singular:"une tomate",singularAr:"حبة طماطم",plural:"des tomates",pluralAr:"حبات طماطم"},
 {singular:"un panier",singularAr:"سلة",plural:"des paniers",pluralAr:"سلال"},
...
const A1_AUX_PLURAL_GROUPS=[
 {label:"-al → -aux",note:"نستبدل -al في آخر الاسم بـ -aux.",items:[
  {singular:"un cheval",singularAr:"حصان",plural:"des chevaux",pluralAr:"خيول",singularEnding:"al",pluralEnding:"aux"},
  {singular:"un journal",singularAr:"صحيفة",plural:"des journaux",pluralAr:"صحف",singularEnding:"al",pluralEnding:"aux"}
 ]},
 {label:"-au → -aux",note:"نضيف x إلى الاسم المنتهي بـ -au.",items:[
  {singular:"un tuyau",singularAr:"أنبوب",plural:"des tuyaux",pluralAr:"أنابيب",singularEnding:"au",pluralEnding:"aux"}
 ]},
 {label:"-eau → -eaux",note:"نضيف x إلى الاسم المنتهي بـ -eau؛ فتصبح النهاية -eaux.",items:[
  {singular:"un bateau",singularAr:"قارب",plural:"des bateaux",pluralAr:"قوارب",singularEnding:"eau",pluralEnding:"eaux"},
  {singular:"un chapeau",singularAr:"قبعة",plural:"des chapeaux",pluralAr:"قبعات",singularEnding:"eau",pluralEnding:"eaux"}
 ]},
 {label:"استثناء",note:"بعض الأسماء المنتهية بـ -al تجمع بإضافة s، لا بتحويلها إلى -aux.",items:[
  {singular:"un festival",singularAr:"مهرجان",plural:"des festivals",pluralAr:"مهرجانات",singularEnding:"al",pluralEnding:"als"}
 ]}
];

const A1_PLURAL_ARTICLE_GROUPS=[
 {label:"التعريف",article:"les",note:"أمام الاسم الجمع المحدد، نستخدم les بدل le أو la أو l’.",items:[
  {singularArticle:"le",singularNoun:"stylo",singularAr:"القلم",pluralNoun:"stylos",pluralAr:"الأقلام"},
  {singularArticle:"la",singularNoun:"chaise",singularAr:"الكرسي",pluralNoun:"chaises",pluralAr:"الكراسي"},
  {singularArticle:"l’",singularNoun:"avion",singularAr:"الطائرة",pluralNoun:"avions",pluralAr:"الطائرات"}
 ]},
 {label:"التنكير",article:"des",note:"أمام الاسم الجمع غير المحدد، نستخدم des بدل un أو une. هنا des أداة تنكير للجمع، وليست دمج de + les.",items:[
  {singularArticle:"un",singularNoun:"cahier",singularAr:"دفتر",pluralNoun:"cahiers",pluralAr:"دفاتر"},
  {singularArticle:"une",singularNoun:"tasse",singularAr:"كوب",pluralNoun:"tasses",pluralAr:"أكواب"},
  {singularArticle:"un",singularNoun:"vélo",singularAr:"دراجة",pluralNoun:"vélos",pluralAr:"دراجات"}
 ]}
];

const A1_NOUN_TRANSFORMATION_GROUPS=[
 {fr:"Ajouter -e",ar:"إضافة e",note:"نضيف الحرف e إلى آخر الاسم المذكر.",items:[
  {masculine:"l’ami",feminine:"l’amie",masculineAr:"الصديق",feminineAr:"الصديقة"},{masculine:"l’étudiant",feminine:"l’étudiante",masculineAr:"الطالب",feminineAr:"الطالبة"},{masculine:"le voisin",feminine:"la voisine",masculineAr:"الجار",feminineAr:"الجارة"},{masculine:"le cousin",feminine:"la cousine",masculineAr:"ابن العم",feminineAr:"ابنة العم"},{masculine:"le client",feminine:"la cliente",masculineAr:"العميل",feminineAr:"العميلة"},{masculine:"le marchand",feminine:"la marchande",masculineAr:"البائع",feminineAr:"البائعة"}
 ]},
 {fr:"Doubler la consonne + -e",ar:"مضاعفة الحرف الأخير + e",note:"نضاعف الحرف الساكن الأخير، ثم نضيف e.",items:[
  {masculine:"le chat",feminine:"la chatte",masculineAr:"القط",feminineAr:"القطة"},{masculine:"le chien",feminine:"la chienne",masculineAr:"الكلب",feminineAr:"الكلبة"},{masculine:"le lion",feminine:"la lionne",masculineAr:"الأسد",feminineAr:"اللبؤة"},{masculine:"le musicien",feminine:"la musicienne",masculineAr:"الموسيقي",feminineAr:"الموسيقية"},{masculine:"l’Italien",feminine:"l’Italienne",masculineAr:"الإيطالي",feminineAr:"الإيطالية"}
 ]},
 {fr:"Changer la terminaison",ar:"تغيير النهاية",note:"تتغير نهاية الاسم عند تأنيثه، مثل -eur إلى -euse أو -teur إلى -trice.",items:[
  {masculine:"le boulanger",feminine:"la boulangère",masculineAr:"الخباز",feminineAr:"الخبازة"},{masculine:"le coiffeur",feminine:"la coiffeuse",masculineAr:"مصفف الشعر",feminineAr:"مصففة الشعر"},{masculine:"le vendeur",feminine:"la vendeuse",masculineAr:"البائع",feminineAr:"البائعة"},{masculine:"le chanteur",feminine:"la chanteuse",masculineAr:"المغني",feminineAr:"المغنية"},{masculine:"l’acteur",feminine:"l’actrice",masculineAr:"الممثل",feminineAr:"الممثلة"}
 ]},
 {fr:"Changer de mot",ar:"تغيير الكلمة كاملة",note:"بعض أسماء الأشخاص لها كلمة مؤنثة مختلفة تمامًا.",items:[
  {masculine:"le père",feminine:"la mère",masculineAr:"الأب",feminineAr:"الأم"},{masculine:"le frère",feminine:"la sœur",masculineAr:"الأخ",feminineAr:"الأخت"},{masculine:"l’homme",feminine:"la femme",masculineAr:"الرجل",feminineAr:"المرأة"},{masculine:"le garçon",feminine:"la fille",masculineAr:"الولد",feminineAr:"البنت"},{masculine:"l’oncle",feminine:"la tante",masculineAr:"العم أو الخال",feminineAr:"العمة أو الخالة"}
 ]}
];
...
const A1_CORE_VERBS_LISTENING={
 ...
 arTitle:"فعلا être وavoir في المضارع",
 text:"Je suis en classe. Tu as un livre. Il est à Paris. Elle a deux frères. On est ici. Nous avons un cours. Vous êtes à l’école. Ils sont étudiants. Elles ont un chat.",
 questions:[
  {prompt:"Quelle phrase entendez-vous ?",translation:"أي جملة تسمع؟",choices:["Je suis en classe.","Je suis à la maison.","Nous sommes en classe."],correctIndex:0},
  {prompt:"Quel verbe est utilisé ?",translation:"أي فعل استُخدم؟",choices:["être","avoir","aller"],correctIndex:1},
  {prompt:"Où est-il ?",translation:"أين هو؟",choices:["À Lyon.","À Paris.","À la maison."],correctIndex:1},
  {prompt:"Combien de frères a-t-elle ?",translation:"كم أخًا لديها؟",choices:["Un frère.","Deux frères.","Trois frères."],correctIndex:1},
  {prompt:"Quel pronom entendez-vous ?",translation:"أي ضمير تسمع؟",choices:["On","Nous","Vous"],correctIndex:0},
  {prompt:"Qu’est-ce que nous avons ?",translation:"ماذا لدينا؟",choices:["Un cours.","Un livre.","Une voiture."],correctIndex:0},
  {prompt:"Où êtes-vous ?",translation:"أين أنتم؟",choices:["À la gare.","À la maison.","À l’école."],correctIndex:2},
  {prompt:"Qui sont étudiants ?",translation:"من هم الطلاب؟",choices:["Ils","Elles","Nous"],correctIndex:0},
  {prompt:"Quel animal ont-elles ?",translation:"أي حيوان لديهن؟",choices:["Un chat.","Un chien.","Un cheval."],correctIndex:0}
 ]
};
...
const A1_CORE_VERBS_WRITING_TRANSLATIONS=[
 {fr:"je suis ici",ar:"أنا هنا"},
 {fr:"j’ai un livre",ar:"لديّ كتاب"},
 {fr:"tu es à la gare",ar:"أنت في المحطة"},
 {fr:"tu as faim",ar:"أنت جائع"},
 {fr:"il est médecin",ar:"هو طبيب"},
 {fr:"elle a un stylo",ar:"لديها قلم"},
 {fr:"on est en classe",ar:"نحن في الصف"},
 {fr:"nous sommes voisins",ar:"نحن جيران"},
 {fr:"nous avons une voiture",ar:"لدينا سيارة"},
 {fr:"vous êtes en retard",ar:"أنتم متأخرون"},
 {fr:"vous avez raison",ar:"أنتم على حق"},
 {fr:"ils sont au parc",ar:"هم في الحديقة"},
 {fr:"elles ont soif",ar:"هنّ عطشى"}
];
...
const A1_CORE_VERBS_BUILDERS=[
 {tokens:["étudiant.","Je","suis"],answer:["Je","suis","étudiant."],ar:"أنا طالب.",explanationAr:"مع je نصرّف être إلى suis.",explanationFr:"Avec je, on dit suis."},
 {tokens:["ami.","Tu","mon","es"],answer:["Tu","es","mon","ami."],ar:"أنت صديقي.",explanationAr:"مع tu نصرّف être إلى es.",explanationFr:"Avec tu, on dit es."},
 {tokens:["un","Il","livre.","a"],answer:["Il","a","un","livre."],ar:"لديه كتاب.",explanationAr:"مع il نصرّف avoir إلى a.",explanationFr:"Avec il, on dit a."},
 {tokens:["à","Elle","l’école.","est"],answer:["Elle","est","à","l’école."],ar:"هي في المدرسة.",explanationAr:"مع elle نصرّف être إلى est لتحديد المكان.",explanationFr:"Avec elle, on dit est."},
 {tokens:["cours.","On","un","a"],answer:["On","a","un","cours."],ar:"لدينا درس.",explanationAr:"عندما تعني on «نحن»، يبقى الفعل في صيغة المفرد: a.",explanationFr:"Avec on, on dit a."},
 {tokens:["prêts.","Nous","sommes"],answer:["Nous","sommes","prêts."],ar:"نحن مستعدون.",explanationAr:"مع nous نصرّف être إلى sommes.",explanationFr:"Avec nous, on dit sommes."},
 {tokens:["deux","avez","Vous","billets."],answer:["Vous","avez","deux","billets."],ar:"لديكم تذكرتان.",explanationAr:"مع vous نصرّف avoir إلى avez.",explanationFr:"Avec vous, on dit avez."},
 {tokens:["au","sont","Ils","café."],answer:["Ils","sont","au","café."],ar:"هم في المقهى.",explanationAr:"مع ils نصرّف être إلى sont.",explanationFr:"Avec ils, on dit sont."},
...
const A1_PRESENT_BUILDERS=[
 {tokens:["amis.","français","parle","Je","avec","mes"],answer:["Je","parle","français","avec","mes","amis."],ar:"أنا أتحدث الفرنسية مع أصدقائي.",explanationAr:"Je هو الفاعل، ثم الفعل parle، ثم بقية الجملة.",explanationFr:"Je est le sujet, puis vient le verbe parle."},
 {tokens:["à","le","Nous","midi.","cours","finissons"],answer:["Nous","finissons","le","cours","à","midi."],ar:"نحن ننهي الدرس عند الظهر.",explanationAr:"مع nous نستخدم finissons، ثم المفعول والوقت.",explanationFr:"Avec nous, on emploie finissons."},
 {tokens:["pas","ne","bus.","le","Elle","prend"],answer:["Elle","ne","prend","pas","le","bus."],ar:"هي لا تستقل الحافلة.",explanationAr:"في النفي نضع ne قبل الفعل prend وpas بعده.",explanationFr:"Dans la négation, ne est avant prend et pas après."},
 {tokens:["marché.","au","allez","Vous"],answer:["Vous","allez","au","marché."],ar:"أنتم تذهبون إلى السوق.",explanationAr:"مع vous يكون تصريف aller هو allez.",explanationFr:"Avec vous, aller devient allez."},
 {tokens:["ce","viennent","Ils","soir.","pas","ne"],answer:["Ils","ne","viennent","pas","ce","soir."],ar:"هم لا يأتون هذا المساء.",explanationAr:"ne…pas يحيطان بالفعل viennent في جملة النفي.",explanationFr:"Ne…pas encadre le verbe viennent."},
 {tokens:["pas","pain.","Je","n’achète","de"],answer:["Je","n’achète","pas","de","pain."],ar:"أنا لا أشتري خبزًا.",explanationAr:"قبل الحرف المتحرك تصبح ne هي n’، وبعد النفي نستخدم de.",explanationFr:"Ne devient n’ devant une voyelle, puis on emploie de après la négation."},
 {tokens:["pas","Ce","livre.","un","n’est"],answer:["Ce","n’est","pas","un","livre."],ar:"هذا ليس كتابًا.",explanationAr:"مع être تبقى الأداة un كما هي بعد النفي.",explanationFr:"Avec être, l’article un reste après la négation."},
 {tokens:["pas","Nous","sommes","prêts.","ne"],answer:["Nous","ne","sommes","pas","prêts."],ar:"نحن لسنا مستعدين.",explanationAr:"النفي يحيط بتصريف être: ne sommes pas.",explanationFr:"La négation encadre être : ne sommes pas."}
];
...
const A1_HOME_HOUSING_WRITING_TRANSLATIONS=[
 {fr:"un appartement calme",ar:"شقة هادئة"},
 {fr:"une petite maison",ar:"منزل صغير"},
 {fr:"deux chambres",ar:"غرفتا نوم"},
 {fr:"un petit balcon",ar:"شرفة صغيرة"},
 {fr:"dans le salon",ar:"في غرفة الجلوس"},
 {fr:"devant la fenêtre",ar:"أمام النافذة"},
 {fr:"à côté de la porte",ar:"بجوار الباب"},
...
const A1_HOME_HOUSING_READING={
 ...
 questions:[
  {question:"Quelle est l’adresse de Youssef ?",translation:"ما عنوان يوسف؟",answer:"Il habite au 24, rue des Fleurs, à Nantes.",ar:"يسكن في 24 شارع دي فلور بمدينة نانت."},
  {question:"Combien de chambres y a-t-il ?",translation:"كم غرفة نوم توجد؟",answer:"Il y a deux chambres.",ar:"توجد غرفتا نوم."},
  {question:"Où est la lampe ?",translation:"أين يوجد المصباح؟",answer:"La lampe est à côté de la bibliothèque.",ar:"المصباح بجوار خزانة الكتب."}
 ]
};
...
const A1_HOME_HOUSING_DIALOGUES=[
 {context:"Vous habitez où ?",translation:"أين تسكن؟",prompt:"اختر إجابة كاملة.",choices:["J’habite dans un appartement à Lyon.","Je suis un appartement Lyon.","J’habite au troisième chambre."],correctIndex:0,feedback:"نستخدم habiter dans مع نوع المسكن، ثم à مع المدينة."},
 {context:"Qu’est-ce qu’il y a dans le salon ?",translation:"ماذا يوجد في غرفة الجلوس؟",prompt:"اختر الجملة الصحيحة.",choices:["Il y a un canapé dans le salon.","Le salon a il canapé.","Il est canapé au salon."],correctIndex:0,feedback:"Il y a تقدّم شيئًا موجودًا داخل المكان."},
 {context:"Où est la lampe ?",translation:"أين يوجد المصباح؟",prompt:"اختر التعبير المناسب.",choices:["La lampe est à côté du lit.","La lampe est entre le lit.","La lampe est sous à lit."],correctIndex:0,feedback:"à côté de تعني بجوار، وتصبح du قبل الاسم المذكر المعرف."},
 {context:"À quel étage habitez-vous ?",translation:"في أي طابق تسكنون؟",prompt:"اختر الرد المناسب.",choices:["J’habite au troisième étage.","J’habite trois chambres.","J’habite à la cuisine."],correctIndex:0,feedback:"نستخدم au مع رقم الطابق."},
...
const A1_SUBJECT_PRONOUN_GROUPS=[
 {
  ...
  items:[
   {fr:"je / j’",audio:"Je",ar:"أنا",explanation:"للمتكلم المفرد. تُنطق je قبل الحرف الساكن، وتصبح j’ قبل صوت متحرك أو h غير منطوقة؛ مثل j’ai.",examples:[{fr:"Je suis Adam.",ar:"أنا آدم.",kind:"شخص"},{fr:"J’ai un livre.",ar:"لديّ كتاب.",kind:"شيء"}]},
...
const A1_STUDY_VERB_CARDS=[
 {fr:"étudier",ar:"يدرس",image:"/images/university/a1-studies/verbs/etudier.webp",example:"J’étudie le soir.",exampleAr:"أدرس في المساء."},
 {fr:"apprendre",ar:"يتعلّم",image:"/images/university/a1-studies/verbs/apprendre.webp",example:"J’apprends le français.",exampleAr:"أتعلّم اللغة الفرنسية."},
 {fr:"lire",ar:"يقرأ",image:"/images/university/a1-studies/verbs/lire.webp",example:"Je lis un livre.",exampleAr:"أقرأ كتابًا."},
 {fr:"écrire",ar:"يكتب",image:"/images/university/a1-studies/verbs/ecrire.webp",example:"J’écris une phrase.",exampleAr:"أكتب جملة."},
...
const A1_STUDY_PROFESSION_CARDS:{fr:string;ar:string;example:string;exampleAr:string;icon:LucideIcon;visual:string}[]=[
 ...
 {fr:"le policier",ar:"الشرطي",example:"Il est policier.",exampleAr:"هو شرطي.",icon:BadgeCheck,visual:"police"},
 {fr:"le pilote",ar:"الطيار",example:"Le pilote est dans l’avion.",exampleAr:"الطيار في الطائرة.",icon:Navigation,visual:"pilot"},
 {fr:"l’ingénieur",ar:"المهندس",example:"Mon frère est ingénieur.",exampleAr:"أخي مهندس.",icon:Blocks,visual:"engineer"},
...
const A1_WORKPLACE_CARDS:{fr:string;ar:string;place:string;placeAr:string;example:string;exampleAr:string;icon:LucideIcon;visual:string}[]=[
...
];const A1_STUDY_QUESTION_CARDS={
 informal:[
  {topic:"الدراسة",question:"Qu’est-ce que tu étudies ?",questionAr:"ماذا تدرس؟",answer:"J’étudie le français.",answerAr:"أدرس اللغة الفرنسية."},
  {topic:"مكان الدراسة",question:"Tu étudies où ?",questionAr:"أين تدرس؟",answer:"J’étudie à l’université.",answerAr:"أدرس في الجامعة."},
  {topic:"المهنة",question:"Quel est ton métier ?",questionAr:"ما مهنتك؟",answer:"Je suis médecin.",answerAr:"أنا طبيب."},
  {topic:"مكان العمل",question:"Tu travailles où ?",questionAr:"أين تعمل؟",answer:"Je travaille à l’hôpital.",answerAr:"أعمل في المستشفى."}
 ],
 formal:[
  {topic:"الدراسة",question:"Qu’est-ce que vous étudiez ?",questionAr:"ماذا تدرس / تدرسون؟",answer:"J’étudie le français.",answerAr:"أدرس اللغة الفرنسية."},
  {topic:"مكان الدراسة",question:"Où étudiez-vous ?",questionAr:"أين تدرس / تدرسون؟",answer:"J’étudie à l’université.",answerAr:"أدرس في الجامعة."},
  {topic:"المهنة",question:"Quel est votre métier ?",questionAr:"ما مهنتك / مهنتكم؟",answer:"Je suis ingénieur.",answerAr:"أنا مهندس."},
  {topic:"مكان العمل",question:"Où travaillez-vous ?",questionAr:"أين تعمل / تعملون؟",answer:"Je travaille dans un bureau.",answerAr:"أعمل في مكتب."}
 ]
} as const;const A1_STUDY_PRESENTATION_CARDS=[
 {label:"الصفة الدراسية",formula:"Je suis + étudiant",fr:"Je suis étudiant.",ar:"أنا طالب.",note:"تُستعمل مع الطالب المذكر."},
 {label:"الصفة الدراسية",formula:"Je suis + étudiante",fr:"Je suis étudiante.",ar:"أنا طالبة.",note:"تُستعمل مع الطالبة المؤنثة."},
 {label:"المادة",formula:"J’étudie + matière",fr:"J’étudie le français.",ar:"أدرس اللغة الفرنسية.",note:"نذكر المادة بعد الفعل étudier."},
 {label:"مكان الدراسة",formula:"J’étudie + à l’…",fr:"J’étudie à l’université.",ar:"أدرس في الجامعة.",note:"نضيف مكان الدراسة بحرف الجر المناسب."},
 {label:"تعريف كامل",formula:"Je suis + étudiant. J’étudie + …",fr:"Je suis étudiant. J’étudie le français à l’université.",ar:"أنا طالب. أدرس اللغة الفرنسية في الجامعة.",note:"تعريف قصير وواضح يجمع الصفة والمادة والمكان."}
] as const;const A1_PROFESSION_PRESENTATION_CARDS=[
 {label:"قاعدة أساسية",formula:"Je suis + métier",fr:"Je suis serveur.",ar:"أنا نادل.",note:"بعد être نذكر المهنة من دون un أو une."},
 {label:"المذكر",formula:"Il est + métier",fr:"Mon frère est chauffeur.",ar:"أخي سائق.",note:"نستعمل صيغة المذكر عند الحديث عن رجل."},
 {label:"المؤنث",formula:"Elle est + métier",fr:"Ma sœur est vendeuse.",ar:"أختي بائعة.",note:"نستعمل صيغة المؤنث عند الحديث عن امرأة."},
 {label:"شكل واحد",formula:"Elle est + métier",fr:"Elle est photographe.",ar:"هي مصوّرة.",note:"بعض أسماء المهن لها الشكل نفسه للمذكر والمؤنث."},
 {label:"تعريف كامل",formula:"Je suis + métier. Je travaille + …",fr:"Je suis serveur. Je travaille dans un restaurant.",ar:"أنا نادل. أعمل في مطعم.",note:"يمكن إضافة مكان العمل بعد ذكر المهنة."}
] as const;const A1_PLACE_PRESENTATION_CARDS=[
 {label:"مع المكان المذكر",formula:"à + le → au",fr:"J’étudie au collège.",ar:"أدرس في المدرسة المتوسطة.",note:"نختصر à + le إلى au قبل الاسم المذكر."},
 {label:"مع المكان المؤنث",formula:"à + la",fr:"Ma sœur travaille à la boulangerie.",ar:"أختي تعمل في المخبز.",note:"نستخدم à la قبل اسم المكان المؤنث."},
 {label:"قبل حرف متحرك",formula:"à + l’…",fr:"Mon oncle travaille à l’aéroport.",ar:"عمي يعمل في المطار.",note:"نستخدم à l’ قبل اسم يبدأ بصوت متحرك."},
 {label:"داخل المكان",formula:"dans + un lieu",fr:"Je travaille dans un bureau.",ar:"أعمل داخل مكتب.",note:"نستخدم dans عندما نريد التأكيد على الوجود داخل المكان."},
 {label:"تعريف كامل",formula:"Je travaille + lieu",fr:"Je travaille au restaurant, près de l’université.",ar:"أعمل في المطعم، قرب الجامعة.",note:"يمكن إضافة تفاصيل قصيرة عن مكان العمل."}
] as const;function A1StudyPlacesCarousel(){
 ...
 const selectPlace=(nextIndex:number)=>{const nextCard=A1_STUDY_PLACE_CARDS[nextIndex];if(!nextCard||nextIndex===placeIndex)return;setPlaceIndex(nextIndex);setRevealed(true);void speakFrenchWithPause(nextCard.fr,nextCard.example,650,{rate:.72});};
...
function A1StudyVerbsCarousel(){
 const [verbIndex,setVerbIndex]=useState(0);
 const [revealed,setRevealed]=useState(false);
 const card=A1_STUDY_VERB_CARDS[verbIndex];
 const play=()=>{setRevealed(true);void speakFrenchWithPause(card.fr,card.example,650,{rate:.72});};
 const selectVerb=(nextIndex:number)=>{const nextCard=A1_STUDY_VERB_CARDS[nextIndex];if(!nextCard||nextIndex===verbIndex)return;setVerbIndex(nextIndex);setRevealed(true);void speakFrenchWithPause(nextCard.fr,nextCard.example,650,{rate:.72});};
 return <div className="a1-time-greeting-carousel a1-study-verbs-carousel">
  <article className="a1-time-greeting-card a1-study-place-card" key={card.fr}>
   <button type="button" className="a1-time-greeting-image" onClick={play} aria-label={`استمع إلى ${card.fr}`}><img src={card.image} alt="" loading="lazy"/><span aria-hidden="true"><Volume2/></span></button>
   {revealed&&<div className="a1-time-greeting-copy"><strong dir="ltr">{card.fr}</strong><b>{card.ar}</b><p>اضغط على الصورة لإعادة الاستماع إلى النطق.</p><div><span dir="ltr">{card.example}</span><small>{card.exampleAr}</small></div></div>}
  </article>
  <nav className="a1-time-greeting-navigation" dir="ltr" aria-label="التنقل بين أفعال الدراسة"><button type="button" onClick={()=>selectVerb(verbIndex-1)} disabled={verbIndex===0} aria-label="الفعل السابق"><ChevronLeft/></button><span>{verbIndex+1} / {A1_STUDY_VERB_CARDS.length}</span><button type="button" onClick={()=>selectVerb(verbIndex+1)} disabled={verbIndex===A1_STUDY_VERB_CARDS.length-1} aria-label="الفعل التالي"><ChevronRight/></button></nav>
 </div>;
}
function A1StudyProfessionsCarousel(){
 const [professionIndex,setProfessionIndex]=useState(0);
 const [revealed,setRevealed]=useState(false);
 const card=A1_STUDY_PROFESSION_CARDS[professionIndex];
 const ProfessionIcon=card.icon;
 const play=()=>{setRevealed(true);void speakFrenchWithPause(card.fr,card.example,650,{rate:.72});};
 const selectProfession=(nextIndex:number)=>{const nextCard=A1_STUDY_PROFESSION_CARDS[nextIndex];if(!nextCard||nextIndex===professionIndex)return;setProfessionIndex(nextIndex);setRevealed(true);void speakFrenchWithPause(nextCard.fr,nextCard.example,650,{rate:.72});};
 return <div className="a1-time-greeting-carousel a1-study-professions-carousel">
  <article className={`a1-time-greeting-card a1-study-profession-card ${card.visual}`} key={card.fr}>
   <button type="button" className="a1-time-greeting-image" onClick={play} aria-label={`استمع إلى ${card.fr}`}><span className="a1-study-profession-visual" aria-hidden="true"><ProfessionIcon/></span><span aria-hidden="true"><Volume2/></span></button>
...
}function A1StudyQuestionCarousel({mode}:{mode:"informal"|"formal"}){
 const [questionIndex,setQuestionIndex]=useState(0);
 const cards=A1_STUDY_QUESTION_CARDS[mode];
 const card=cards[questionIndex];
 const isFormal=mode==="formal";
 const play=()=>void speakFrenchWithPause(card.question,card.answer,700,{rate:.72});
 const selectCard=(nextIndex:number)=>{const nextCard=cards[nextIndex];if(!nextCard||nextIndex===questionIndex)return;setQuestionIndex(nextIndex);void speakFrenchWithPause(nextCard.question,nextCard.answer,700,{rate:.72});};
 return <div className={`a1-study-question-carousel ${mode}`}>
  <button type="button" className="a1-study-question-card" onClick={play} aria-label={`استمع إلى السؤال والإجابة: ${card.question}`}>
   <header><span>{card.topic}</span><b dir="ltr">{isFormal?"vous":"tu"}</b><Volume2 aria-hidden="true"/></header>
   <section className="a1-study-question-line"><small>السؤال</small><strong dir="ltr">{card.question}</strong><em>{card.questionAr}</em></section>
   <section className="a1-study-answer-line"><small>الإجابة</small><strong dir="ltr">{card.answer}</strong><em>{card.answerAr}</em></section>
   <p>اضغط على البطاقة للاستماع إلى السؤال، ثم الإجابة.</p>
  </button>
  <nav className="a1-time-greeting-navigation a1-study-question-navigation" dir="ltr" aria-label={isFormal?"التنقل بين الأسئلة الرسمية":"التنقل بين الأسئلة غير الرسمية"}><button type="button" onClick={()=>selectCard(questionIndex-1)} disabled={questionIndex===0} aria-label="السؤال السابق"><ChevronLeft/></button><span>{questionIndex+1} / {cards.length}</span><button type="button" onClick={()=>selectCard(questionIndex+1)} disabled={questionIndex===cards.length-1} aria-label="السؤال التالي"><ChevronRight/></button></nav>
 </div>;
}function A1StudyPresentationCarousel({kind="study"}:{kind?:"study"|"profession"|"place"}){
 const [presentationIndex,setPresentationIndex]=useState(0);
 const cards=kind==="study"?A1_STUDY_PRESENTATION_CARDS:kind==="profession"?A1_PROFESSION_PRESENTATION_CARDS:A1_PLACE_PRESENTATION_CARDS;
 const card=cards[presentationIndex];
 const play=()=>void speakFrench(card.fr,{rate:.72});
 const selectCard=(nextIndex:number)=>{const nextCard=cards[nextIndex];if(!nextCard||nextIndex===presentationIndex)return;setPresentationIndex(nextIndex);void speakFrench(nextCard.fr,{rate:.72});};
 return <div className={`a1-study-presentation-carousel ${kind}`}>
  <button type="button" className="a1-study-presentation-card" onClick={play} aria-label={`استمع إلى ${card.fr}`}>
   <header><span>{card.label}</span><Volume2 aria-hidden="true"/></header>
   <div className="a1-study-presentation-formula" dir="ltr">{card.formula}</div>
   <strong dir="ltr">{card.fr}</strong>
   <b>{card.ar}</b>
   <p>{card.note}</p>
  </button>
  <nav className="a1-time-greeting-navigation a1-study-presentation-navigation" dir="ltr" aria-label={kind==="study"?"التنقل بين جمل تقديم الدراسة":kind==="profession"?"التنقل بين جمل تقديم المهنة":"التنقل بين جمل تقديم المكان"}><button type="button" onClick={()=>selectCard(presentationIndex-1)} disabled={presentationIndex===0} aria-label="الجملة السابقة"><ChevronLeft/></button><span>{presentationIndex+1} / {cards.length}</span><button type="button" onClick={()=>selectCard(presentationIndex+1)} disabled={presentationIndex===cards.length-1} aria-label="الجملة التالية"><ChevronRight/></button></nav>
 </div>;
...
function playPresentConjugation(pronoun:string,form:string){
 const forms=pronoun.split(" / ").map(subject=>`${subject} ${form}`);
 return forms.length>1?speakFrenchSequence(forms,520,{rate:.72}):speakFrench(forms[0],{rate:.72});
}
...
function A1PresentErStudio(){
 ...
 return <div className="a1-present-er-studio">
  ...
  <nav className="a1-present-er-tabs" aria-label="اختر فعلًا منتظمًا منتهيًا بـ er">{A1_PRESENT_ER_VERBS.map((item,index)=><button key={item.infinitive} type="button" className={index===verbIndex?"active":""} aria-pressed={index===verbIndex} onClick={()=>{setVerbIndex(index);setFormIndex(0)}} dir="ltr">{item.infinitive}</button>)}</nav>
...
function A1PresentIrStudio(){
 ...
 return <div className="a1-present-er-studio a1-present-ir-studio">
  ...
  <div className="a1-present-er-formula"><span dir="ltr">({verb.infinitive})</span><i>→</i><strong dir="ltr">{verb.root}</strong><b>+ النهاية</b><small>{verb.ar}</small></div>
  <nav className="a1-present-er-tabs" aria-label="اختر فعلًا منتظمًا منتهيًا بـ ir">{A1_PRESENT_IR_VERBS.map((item,index)=><button key={item.infinitive} type="button" className={index===verbIndex?"active":""} aria-pressed={index===verbIndex} onClick={()=>{setVerbIndex(index);setFormIndex(0)}} dir="ltr">{item.infinitive}</button>)}</nav>
  <div className="a1-present-er-table" role="table" aria-label={`تصريف ${verb.infinitive} في المضارع`}>
   <div className="a1-present-er-table-head" role="row"><span aria-hidden="true"></span><span>الضمير</span><span>النهاية</span><span>التصريف</span><span>المثال والنطق</span></div>
   {(()=>{const item=verb.examples[formIndex];const index=formIndex;return <article key={item.pronoun} className="a1-present-er-row" role="row">
...
const A1_TASTES_VERB_TABLE=[
 {infinitive:"aimer",ar:"يحب",use:"للتعبير عن الإعجاب أو المحبة.",forms:[
  {pronoun:"j’",form:"aime",example:"J’aime la musique.",ar:"أحب الموسيقى."},{pronoun:"tu",form:"aimes",example:"Tu aimes lire.",ar:"أنت تحب القراءة."},{pronoun:"il / elle / on",form:"aime",example:"Elle aime le cinéma.",ar:"هي تحب السينما."},{pronoun:"nous",form:"aimons",example:"Nous aimons le thé.",ar:"نحن نحب الشاي."},{pronoun:"vous",form:"aimez",example:"Vous aimez voyager.",ar:"أنتم تحبون السفر."},{pronoun:"ils / elles",form:"aiment",example:"Ils aiment nager.",ar:"هم يحبون السباحة."}]},
 {infinitive:"adorer",ar:"يعشق",use:"للتعبير عن إعجاب قوي.",forms:[
  {pronoun:"j’",form:"adore",example:"J’adore dessiner.",ar:"أعشق الرسم."},{pronoun:"tu",form:"adores",example:"Tu adores les livres.",ar:"أنت تعشق الكتب."},{pronoun:"il / elle / on",form:"adore",example:"On adore le chocolat.",ar:"نحن نعشق الشوكولاتة."},{pronoun:"nous",form:"adorons",example:"Nous adorons chanter.",ar:"نحن نعشق الغناء."},{pronoun:"vous",form:"adorez",example:"Vous adorez le sport.",ar:"أنتم تعشقون الرياضة."},{pronoun:"ils / elles",form:"adorent",example:"Elles adorent danser.",ar:"هن يعشقن الرقص."}]},
 {infinitive:"détester",ar:"يكره",use:"للتعبير عن عدم الإعجاب الشديد.",forms:[
  {pronoun:"je",form:"déteste",example:"Je déteste le bruit.",ar:"أكره الضوضاء."},{pronoun:"tu",form:"détestes",example:"Tu détestes attendre.",ar:"أنت تكره الانتظار."},{pronoun:"il / elle / on",form:"déteste",example:"Il déteste le froid.",ar:"هو يكره البرد."},{pronoun:"nous",form:"détestons",example:"Nous détestons courir.",ar:"نحن نكره الجري."},{pronoun:"vous",form:"détestez",example:"Vous détestez les films tristes.",ar:"أنتم تكرهون الأفلام الحزينة."},{pronoun:"ils / elles",form:"détestent",example:"Elles détestent perdre.",ar:"هن يكرهن الخسارة."}]}
] as const;
function A1TastesPreferenceStudio(){
 const [verbIndex,setVerbIndex]=useState(0);
 const [formIndex,setFormIndex]=useState(0);
 ...
 const speakForm=()=>{
  if(item.pronoun==="il / elle / on")return void speakFrenchSequence([`il ${item.form}`,`elle ${item.form}`,`on ${item.form}`],560,{rate:.72});
  return void speakFrench(spokenForm,{rate:.72});
 };
 return <div className="a1-present-er-studio a1-present-spelling-studio">
  ...
  <nav className="a1-present-er-tabs" aria-label="اختر فعلًا للتعبير عن الذوق">{A1_TASTES_VERB_TABLE.map((entry,index)=><button key={entry.infinitive} type="button" className={index===verbIndex?"active":""} aria-pressed={index===verbIndex} onClick={()=>{setVerbIndex(index);setFormIndex(0)}} dir="ltr">{entry.infinitive}</button>)}</nav>
  <div className="a1-present-er-table" role="table" aria-label={`تصريف ${verb.infinitive}`}><div className="a1-present-er-table-head" role="row"><span aria-hidden="true"></span><span>الضمير</span><span>المصدر</span><span>التصريف</span><span>المثال والنطق</span></div><article className="a1-present-er-row" role="row"><i>{String(formIndex+1).padStart(2,"0")}</i><div className="a1-present-er-pronoun"><strong dir="ltr">{item.pronoun}</strong><small>مع {item.pronoun}</small></div><div className="a1-present-er-ending"><strong dir="ltr">{verb.infinitive}</strong><span>المصدر</span></div><button type="button" className="a1-present-er-form" onClick={speakForm} aria-label={`استمع إلى ${item.pronoun} ${item.form}`}><small>التصريف مع الضمير</small><strong dir="ltr">{item.pronoun} <mark>{item.form}</mark></strong><Volume2 aria-hidden="true"/></button><button type="button" className="a1-present-er-example" onClick={()=>void speakFrench(item.example,{rate:.74})} aria-label={`استمع إلى ${item.example}`}><span dir="ltr">{item.example}</span><small>{item.ar}</small><Volume2 aria-hidden="true"/></button></article></div>
  <div className="a1-present-er-pagination" aria-label="التنقل بين بطاقات الضمائر"><button type="button" onClick={()=>setFormIndex(current=>Math.max(0,current-1))} disabled={formIndex===0} aria-label="الضمير السابق"><ChevronRight/><span>السابق</span></button><b>بطاقة {formIndex+1} من {verb.forms.length}</b><button type="button" onClick={()=>setFormIndex(current=>Math.min(verb.forms.length-1,current+1))} disabled={formIndex===verb.forms.length-1} aria-label="الضمير التالي"><span>التالي</span><ChevronLeft/></button></div>
 </div>
}
const A1_TASTES_PREFERENCE_FORMS=[
 {pronoun:"je",form:"préfère",example:"Je préfère le thé au café.",ar:"أفضل الشاي على القهوة."},
 {pronoun:"tu",form:"préfères",example:"Tu préfères lire ou regarder un film ?",ar:"هل تفضل القراءة أم مشاهدة فيلم؟"},
 {pronoun:"il / elle / on",form:"préfère",example:"Elle préfère la musique calme.",ar:"هي تفضل الموسيقى الهادئة."},
 {pronoun:"nous",form:"préférons",example:"Nous préférons rester à la maison.",ar:"نحن نفضل البقاء في المنزل."},
 {pronoun:"vous",form:"préférez",example:"Vous préférez le bus ou le métro ?",ar:"هل تفضلون الحافلة أم المترو؟"},
 {pronoun:"ils / elles",form:"préfèrent",example:"Ils préfèrent jouer dehors.",ar:"هم يفضلون اللعب في الخارج."}
] as const;
function A1TastesPreferenceChoiceStudio(){
 const [formIndex,setFormIndex]=useState(0);
 const item=A1_TASTES_PREFERENCE_FORMS[formIndex];
 const speakForm=()=>{
  if(item.pronoun==="il / elle / on")return void speakFrenchSequence([`il ${item.form}`,`elle ${item.form}`,`on ${item.form}`],560,{rate:.72});
  return void speakFrench(`${item.pronoun} ${item.form}`,{rate:.72});
 };
 return <div className="a1-present-er-studio a1-present-spelling-studio">
  <div className="a1-present-er-intro"><div><span>Préférer et choisir</span><strong>التفضيل والاختيار</strong><p>نستعمل préférer لاختيار شيء أو نشاط على آخر.</p></div><button type="button" onClick={()=>void speakFrench("préférer",{rate:.72})} aria-label="استمع إلى préférer"><span><small>المصدر</small><strong dir="ltr">préférer</strong></span><Volume2 aria-hidden="true"/></button></div>
  <div className="a1-present-er-formula"><span dir="ltr">é → è</span><i>→</i><strong>تغيير إملائي</strong><b>مع je, tu, il / elle / on, ils / elles</b><small>يبقى é مع nous و vous</small></div>
  <div className="a1-present-er-table" role="table" aria-label="تصريف préférer"><div className="a1-present-er-table-head" role="row"><span aria-hidden="true"></span><span>الضمير</span><span>القاعدة</span><span>التصريف</span><span>المثال والنطق</span></div><article className="a1-present-er-row" role="row"><i>{String(formIndex+1).padStart(2,"0")}</i><div className="a1-present-er-pronoun"><strong dir="ltr">{item.pronoun}</strong><small>مع {item.pronoun}</small></div><div className="a1-present-er-ending"><strong dir="ltr">{formIndex===3||formIndex===4?"é":"é → è"}</strong><span>التغيير</span></div><button type="button" className="a1-present-er-form" onClick={speakForm} aria-label={`استمع إلى ${item.pronoun} ${item.form}`}><small>التصريف مع الضمير</small><strong dir="ltr">{item.pronoun} <mark>{item.form}</mark></strong><Volume2 aria-hidden="true"/></button><button type="button" className="a1-present-er-example" onClick={()=>void speakFrench(item.example,{rate:.74})} aria-label={`استمع إلى ${item.example}`}><span dir="ltr">{item.example}</span><small>{item.ar}</small><Volume2 aria-hidden="true"/></button></article></div>
  <div className="a1-present-er-pagination" aria-label="التنقل بين تصريفات préférer"><button type="button" onClick={()=>setFormIndex(current=>Math.max(0,current-1))} disabled={formIndex===0} aria-label="الضمير السابق"><ChevronRight/><span>السابق</span></button><b>بطاقة {formIndex+1} من {A1_TASTES_PREFERENCE_FORMS.length}</b><button type="button" onClick={()=>setFormIndex(current=>Math.min(A1_TASTES_PREFERENCE_FORMS.length-1,current+1))} disabled={formIndex===A1_TASTES_PREFERENCE_FORMS.length-1} aria-label="الضمير التالي"><span>التالي</span><ChevronLeft/></button></div>
 </div>
}
const A1_TASTES_CHOOSE_FORMS=[
 {pronoun:"je",form:"choisis",example:"Je choisis le thé.",ar:"أختار الشاي."},{pronoun:"tu",form:"choisis",example:"Tu choisis un livre.",ar:"أنت تختار كتابًا."},{pronoun:"il / elle / on",form:"choisit",example:"Il choisit le bus.",ar:"هو يختار الحافلة."},{pronoun:"nous",form:"choisissons",example:"Nous choisissons un film.",ar:"نحن نختار فيلمًا."},{pronoun:"vous",form:"choisissez",example:"Vous choisissez le menu.",ar:"أنتم تختارون القائمة."},{pronoun:"ils / elles",form:"choisissent",example:"Elles choisissent la musique.",ar:"هن يخترن الموسيقى."}
] as const;
function A1TastesChoiceStudio(){
 const [formIndex,setFormIndex]=useState(0);
 const item=A1_TASTES_CHOOSE_FORMS[formIndex];
 const speakForm=()=>item.pronoun==="il / elle / on"?void speakFrenchSequence([`il ${item.form}`,`elle ${item.form}`,`on ${item.form}`],560,{rate:.72}):void speakFrench(`${item.pronoun} ${item.form}`,{rate:.72});
 return <div className="a1-present-er-studio a1-present-spelling-studio"><div className="a1-present-er-intro"><div><span>Choisir</span><strong>الاختيار</strong><p>نستعمل choisir لاختيار شخص أو شيء أو نشاط.</p></div><button type="button" onClick={()=>void speakFrench("choisir",{rate:.72})}><span><small>المصدر</small><strong dir="ltr">choisir</strong></span><Volume2/></button></div><div className="a1-present-er-formula"><span dir="ltr">-ir</span><i>→</i><strong>فعل منتظم</strong><b>يختار</b><small>نضيف: is، is، it، issons، issez، issent</small></div><div className="a1-present-er-table" role="table"><div className="a1-present-er-table-head" role="row"><span/><span>الضمير</span><span>المصدر</span><span>التصريف</span><span>المثال والنطق</span></div><article className="a1-present-er-row" role="row"><i>{String(formIndex+1).padStart(2,"0")}</i><div className="a1-present-er-pronoun"><strong dir="ltr">{item.pronoun}</strong><small>مع {item.pronoun}</small></div><div className="a1-present-er-ending"><strong dir="ltr">choisir</strong><span>المصدر</span></div><button type="button" className="a1-present-er-form" onClick={speakForm}><small>التصريف مع الضمير</small><strong dir="ltr">{item.pronoun} <mark>{item.form}</mark></strong><Volume2/></button><button type="button" className="a1-present-er-example" onClick={()=>void speakFrench(item.example,{rate:.74})}><span dir="ltr">{item.example}</span><small>{item.ar}</small><Volume2/></button></article></div><div className="a1-present-er-pagination"><button type="button" onClick={()=>setFormIndex(i=>Math.max(0,i-1))} disabled={formIndex===0}><ChevronRight/><span>السابق</span></button><b>بطاقة {formIndex+1} من {A1_TASTES_CHOOSE_FORMS.length}</b><button type="button" onClick={()=>setFormIndex(i=>Math.min(A1_TASTES_CHOOSE_FORMS.length-1,i+1))} disabled={formIndex===A1_TASTES_CHOOSE_FORMS.length-1}><span>التالي</span><ChevronLeft/></button></div></div>
}
const A1_TASTES_REASON_SECTIONS=[
 {fr:"Poser une question",ar:"السؤال عن الميول",note:"نسأل عمّا يحب الشخص أو يفضله.",items:[{fr:"Qu’est-ce que tu aimes ?",ar:"ماذا تحب؟"},{fr:"Tu préfères le thé ou le café ?",ar:"هل تفضل الشاي أم القهوة؟"},{fr:"Pourquoi aimes-tu ce livre ?",ar:"لماذا تحب هذا الكتاب؟"}]},
 {fr:"Donner une raison",ar:"ذكر السبب",note:"نستعمل parce que ثم جملة بسيطة لشرح السبب.",items:[{fr:"J’aime ce film parce qu’il est drôle.",ar:"أحب هذا الفيلم لأنه مضحك."},{fr:"Je préfère marcher parce que c’est calme.",ar:"أفضل المشي لأنه هادئ."},{fr:"Elle adore lire parce que c’est intéressant.",ar:"هي تعشق القراءة لأنها ممتعة."}]},
 {fr:"Comparer",ar:"المقارنة",note:"مع préférer نستعمل à / au / aux قبل الخيار الثاني. وللمقارنة في درجة الإعجاب نستعمل aimer + plus que؛ لا نقول préférer plus que في هذا التركيب.",items:[{fr:"Je préfère le thé au café.",ar:"أفضل الشاي على القهوة."},{fr:"Nous préférons le train à la voiture.",ar:"نفضل القطار على السيارة."},{fr:"Il préfère lire aux jeux vidéo.",ar:"هو يفضل القراءة على ألعاب الفيديو."},{fr:"J’aime le thé plus que le café.",ar:"أحب الشاي أكثر من القهوة."},{fr:"Elle aime lire plus que regarder la télé.",ar:"هي تحب القراءة أكثر من مشاهدة التلفاز."}]}
] as const;
function A1TastesReasonStudio(){
 const [sectionIndex,setSectionIndex]=useState(0); const section=A1_TASTES_REASON_SECTIONS[sectionIndex];
 return <div className="a1-present-er-studio a1-present-spelling-studio"><div className="a1-present-er-intro"><div><span>{section.fr}</span><strong>{section.ar}</strong><p>{section.note}</p></div><button type="button" onClick={()=>void speakFrench(section.items[0].fr,{rate:.72})}><span><small>استمع إلى المثال</small><strong dir="ltr">{section.items[0].fr}</strong></span><Volume2/></button></div><nav className="a1-present-er-tabs">{A1_TASTES_REASON_SECTIONS.map((entry,index)=><button key={entry.fr} type="button" className={index===sectionIndex?"active":""} onClick={()=>setSectionIndex(index)}>{entry.ar}</button>)}</nav><div className="a1-present-er-table" role="table"><div className="a1-present-er-table-head" role="row"><span/><span>الوظيفة</span><span>التركيب</span><span>العبارة</span><span>الترجمة والنطق</span></div>{section.items.map((item,index)=><article className="a1-present-er-row" role="row" key={item.fr}><i>{String(index+1).padStart(2,"0")}</i><div className="a1-present-er-pronoun"><strong>{section.ar}</strong><small>{section.fr}</small></div><div className="a1-present-er-ending"><strong dir="ltr">{sectionIndex===0?"Question":sectionIndex===1?"Parce que":"Préférer + à / Aimer + plus que"}</strong><span>التركيب</span></div><button type="button" className="a1-present-er-form" onClick={()=>void speakFrench(item.fr,{rate:.72})}><small>استمع إلى العبارة</small><strong dir="ltr"><mark>{item.fr}</mark></strong><Volume2/></button><div className="a1-present-er-example"><span>{item.ar}</span></div></article>)}</div></div>
}
const A1_PRESENT_NEGATION_GROUPS=[
 {fr:"La négation de base",ar:"النفي الأساسي ne…pas",note:"نضع ne قبل الفعل المصرف وpas بعده، ولا نغيّر تصريف الفعل.",items:[
  {affirmative:"Je parle français.",affirmativeAr:"أنا أتحدث الفرنسية.",negative:"Je ne parle pas français.",negativeAr:"أنا لا أتحدث الفرنسية."},{affirmative:"Nous travaillons le matin.",affirmativeAr:"نحن نعمل صباحًا.",negative:"Nous ne travaillons pas le matin.",negativeAr:"نحن لا نعمل صباحًا."},{affirmative:"Tu finis le livre.",affirmativeAr:"أنت تنهي الكتاب.",negative:"Tu ne finis pas le livre.",negativeAr:"أنت لا تنهي الكتاب."}]},
 {fr:"Ne devient n’",ar:"اختصار ne إلى n’",note:"قبل صوت متحرك أو h صامتة نكتب n’ بدل ne.",items:[
  {affirmative:"Elle habite ici.",affirmativeAr:"هي تسكن هنا.",negative:"Elle n’habite pas ici.",negativeAr:"هي لا تسكن هنا."},{affirmative:"Il écoute la radio.",affirmativeAr:"هو يستمع إلى الراديو.",negative:"Il n’écoute pas la radio.",negativeAr:"هو لا يستمع إلى الراديو."},{affirmative:"On arrive à midi.",affirmativeAr:"نحن نصل عند الظهر.",negative:"On n’arrive pas à midi.",negativeAr:"نحن لا نصل عند الظهر."}]},
 {fr:"Avec les verbes fréquents",ar:"النفي مع الأفعال الشائعة",note:"يبقى النفي حول الفعل المصرف نفسه، حتى مع الأفعال غير المنتظمة.",items:[
  {affirmative:"Nous sommes prêts.",affirmativeAr:"نحن مستعدون.",negative:"Nous ne sommes pas prêts.",negativeAr:"نحن لسنا مستعدين."},{affirmative:"Vous allez au marché.",affirmativeAr:"أنتم تذهبون إلى السوق.",negative:"Vous n’allez pas au marché.",negativeAr:"أنتم لا تذهبون إلى السوق."},{affirmative:"Ils font un exercice.",affirmativeAr:"هم يؤدون تمرينًا.",negative:"Ils ne font pas un exercice.",negativeAr:"هم لا يؤدون تمرينًا."}]},
 {fr:"Les articles après la négation",ar:"الأدوات بعد النفي",note:"بعد النفي تتحول un وune وdes وdu وde la وde l’ غالبًا إلى de أو d’.",items:[
  {affirmative:"J’ai un livre.",affirmativeAr:"لدي كتاب.",negative:"Je n’ai pas de livre.",negativeAr:"ليس لدي كتاب."},{affirmative:"Elle boit du café.",affirmativeAr:"هي تشرب قهوة.",negative:"Elle ne boit pas de café.",negativeAr:"هي لا تشرب قهوة."},{affirmative:"Ils achètent des fruits.",affirmativeAr:"هم يشترون فواكه.",negative:"Ils n’achètent pas de fruits.",negativeAr:"هم لا يشترون فواكه."}]},
 {fr:"L’exception avec être",ar:"الاستثناء مع être",note:"بعد être تبقى أداة الاسم كما هي؛ لا نحولها إلى de.",items:[
  {affirmative:"C’est un livre.",affirmativeAr:"هذا كتاب.",negative:"Ce n’est pas un livre.",negativeAr:"هذا ليس كتابًا."},{affirmative:"Ce sont des photos.",affirmativeAr:"هذه صور.",negative:"Ce ne sont pas des photos.",negativeAr:"هذه ليست صورًا."},{affirmative:"C’est du café.",affirmativeAr:"هذه قهوة.",negative:"Ce n’est pas du café.",negativeAr:"هذه ليست قهوة."}]}
] as const;

function A1PresentNegationBranches({intro}:{intro:string}){
 const [activeItems,setActiveItems]=useState<Record<number,number>>({});
 return <div className="a1-present-negation-branches"><p className="a1-present-simple-intro">{intro}</p><div className="a1-present-negation-list">{A1_PRESENT_NEGATION_GROUPS.map((group,groupIndex)=>{const activeIndex=activeItems[groupIndex]??0;const item=group.items[activeIndex];return <details key={group.fr} className="a1-present-negation-branch"><summary><span>{String(groupIndex+1).padStart(2,"0")}</span><div><strong dir="ltr">{group.fr}</strong><b>{group.ar}</b></div><ChevronDown aria-hidden="true"/></summary><div className="a1-present-negation-content"><p>{group.note}</p><div className="a1-present-negation-pair"><button type="button" onClick={()=>void speakFrench(item.affirmative,{rate:.74})} aria-label={`استمع إلى ${item.affirmative}`}><small>الإثبات</small><strong dir="ltr">{item.affirmative}</strong><span>{item.affirmativeAr}</span><Volume2 aria-hidden="true"/></button><i aria-hidden="true">←</i><button type="button" onClick={()=>void speakFrench(item.negative,{rate:.74})} aria-label={`استمع إلى ${item.negative}`}><small>النفي</small><strong dir="ltr">{item.negative}</strong><span>{item.negativeAr}</span><Volume2 aria-hidden="true"/></button></div><div className="a1-present-er-pagination"><button type="button" onClick={()=>setActiveItems(current=>({...current,[groupIndex]:Math.max(0,activeIndex-1)}))} disabled={activeIndex===0} aria-label="المثال السابق"><ChevronRight aria-hidden="true"/><span>السابق</span></button><b>مثال {activeIndex+1} من {group.items.length}</b><button type="button" onClick={()=>setActiveItems(current=>({...current,[groupIndex]:Math.min(group.items.length-1,activeIndex+1)}))} disabled={activeIndex===group.items.length-1} aria-label="المثال التالي"><span>التالي</span><ChevronLeft aria-hidden="true"/></button></div></div></details>})}</div></div>
}
...
const A1_DEMONSTRATIVES_MASCULINE_EXAMPLES=[
 {article:"ce",kind:"صوت ساكن",rule:"قبل اسم مذكر يبدأ بصوت ساكن",phrase:"ce livre",ar:"هذا الكتاب",sentence:"Ce livre est facile.",sentenceAr:"هذا الكتاب سهل."},
 {article:"ce",kind:"صوت ساكن",rule:"قبل اسم مذكر يبدأ بصوت ساكن",phrase:"ce chat",ar:"هذا القط",sentence:"Ce chat est noir.",sentenceAr:"هذا القط أسود."},
 {article:"ce",kind:"صوت ساكن",rule:"قبل اسم مذكر يبدأ بصوت ساكن",phrase:"ce professeur",ar:"هذا المعلّم",sentence:"Ce professeur parle français.",sentenceAr:"هذا المعلّم يتحدث الفرنسية."},
 {article:"ce",kind:"صوت ساكن",rule:"قبل اسم مذكر يبدأ بصوت ساكن",phrase:"ce sac",ar:"هذه الحقيبة",sentence:"Ce sac est lourd.",sentenceAr:"هذه الحقيبة ثقيلة."},
 {article:"cet",kind:"صوت متحرك",rule:"قبل اسم مذكر يبدأ بصوت متحرك",phrase:"cet ami",ar:"هذا الصديق",sentence:"Cet ami est gentil.",sentenceAr:"هذا الصديق لطيف."},
 {article:"cet",kind:"صوت متحرك",rule:"قبل اسم مذكر يبدأ بصوت متحرك",phrase:"cet étudiant",ar:"هذا الطالب",sentence:"Cet étudiant arrive tôt.",sentenceAr:"هذا الطالب يصل مبكرًا."},
 {article:"cet",kind:"h صامت",rule:"قبل اسم مذكر يبدأ بـ h صامت",phrase:"cet hôtel",ar:"هذا الفندق",sentence:"Cet hôtel est moderne.",sentenceAr:"هذا الفندق حديث."},
 {article:"cet",kind:"صوت متحرك",rule:"قبل اسم مذكر يبدأ بصوت متحرك",phrase:"cet exercice",ar:"هذا التمرين",sentence:"Cet exercice est facile.",sentenceAr:"هذا التمرين سهل."}
];

function A1DemonstrativesMasculineTable(){
 const [exampleIndex,setExampleIndex]=useState(0);
 const item=A1_DEMONSTRATIVES_MASCULINE_EXAMPLES[exampleIndex];
 const selectGroup=(article:"ce"|"cet")=>setExampleIndex(article==="ce"?0:4);
 return <div className="a1-demonstratives-table" aria-live="polite">
  <div className="a1-demonstratives-tabs" role="group" aria-label="اختر قاعدة صفة الإشارة">
   <button type="button" className={item.article==="ce"?"active":""} aria-pressed={item.article==="ce"} onClick={()=>selectGroup("ce")}><strong dir="ltr">ce</strong><span>قبل صوت ساكن</span></button>
   <button type="button" className={item.article==="cet"?"active":""} aria-pressed={item.article==="cet"} onClick={()=>selectGroup("cet")}><strong dir="ltr">cet</strong><span>قبل صوت متحرك أو h صامت</span></button>
  </div>
  ...
  <div className="university-number-pagination a1-demonstratives-pagination" dir="ltr">
   ...
   <div><small>أمثلة المذكر المفرد</small><strong>{exampleIndex+1} / {A1_DEMONSTRATIVES_MASCULINE_EXAMPLES.length}</strong><em dir="ltr">{item.article}</em></div>
   <button type="button" onClick={()=>setExampleIndex(index=>Math.min(A1_DEMONSTRATIVES_MASCULINE_EXAMPLES.length-1,index+1))} disabled={exampleIndex===A1_DEMONSTRATIVES_MASCULINE_EXAMPLES.length-1} aria-label="المثال التالي"><span>التالي</span><ChevronRight/></button>
  </div>
 </div>;
}
...
const A1_DEMONSTRATIVES_PLURAL_EXAMPLES=[
 {phrase:"ces livres",ar:"هذه الكتب",kind:"جمع مذكر",sentence:"Ces livres sont intéressants.",sentenceAr:"هذه الكتب ممتعة."},
 {phrase:"ces chats",ar:"هذه القطط",kind:"جمع مذكر",sentence:"Ces chats sont calmes.",sentenceAr:"هذه القطط هادئة."},
 {phrase:"ces amis",ar:"هؤلاء الأصدقاء",kind:"جمع مذكر",sentence:"Ces amis parlent français.",sentenceAr:"هؤلاء الأصدقاء يتحدثون الفرنسية."},
 {phrase:"ces hôtels",ar:"هذه الفنادق",kind:"جمع مذكر",sentence:"Ces hôtels sont modernes.",sentenceAr:"هذه الفنادق حديثة."},
 {phrase:"ces maisons",ar:"هذه المنازل",kind:"جمع مؤنث",sentence:"Ces maisons sont grandes.",sentenceAr:"هذه المنازل كبيرة."},
 {phrase:"ces voitures",ar:"هذه السيارات",kind:"جمع مؤنث",sentence:"Ces voitures sont rapides.",sentenceAr:"هذه السيارات سريعة."},
 {phrase:"ces écoles",ar:"هذه المدارس",kind:"جمع مؤنث",sentence:"Ces écoles sont ouvertes.",sentenceAr:"هذه المدارس مفتوحة."},
 {phrase:"ces questions",ar:"هذه الأسئلة",kind:"جمع مؤنث",sentence:"Ces questions sont faciles.",sentenceAr:"هذه الأسئلة سهلة."}
];

function A1DemonstrativesPluralTable(){
 const [exampleIndex,setExampleIndex]=useState(0);
 const item=A1_DEMONSTRATIVES_PLURAL_EXAMPLES[exampleIndex];
 return <div className="a1-demonstratives-table a1-demonstratives-plural-table" aria-live="polite">
  <div className="a1-demonstratives-tabs a1-demonstratives-single-tab"><div><strong dir="ltr">ces</strong><span>مع كل اسم في صيغة الجمع</span></div></div>
  <div className="a1-demonstratives-rule"><span dir="ltr">ces</span><div><small>{item.kind}</small><strong>تُستعمل مع الجمع المذكر والجمع المؤنث.</strong></div></div>
  <div className="a1-demonstratives-grid" key={exampleIndex}>
   <div className="a1-demonstratives-cell"><small>الأداة + الاسم</small><strong dir="ltr"><mark>ces</mark> {item.phrase.slice(4)}</strong><span>{item.ar}</span></div>
   <div className="a1-demonstratives-cell a1-demonstratives-sentence"><small>في جملة</small><strong dir="ltr">{item.sentence}</strong><span>{item.sentenceAr}</span></div>
   <div className="a1-demonstratives-audio"><button type="button" onClick={()=>void speakFrench(item.sentence,{rate:.74})} aria-label={`استمع إلى ${item.sentence}`}><Volume2/><span>استمع</span></button><button type="button" onClick={()=>void speakFrench(item.sentence,{rate:.56})} aria-label={`استمع ببطء إلى ${item.sentence}`}><Turtle/><span>نطق بطيء</span></button></div>
  </div>
  <div className="university-number-pagination a1-demonstratives-pagination" dir="ltr">
   <button type="button" onClick={()=>setExampleIndex(index=>Math.max(0,index-1))} disabled={exampleIndex===0} aria-label="المثال السابق"><ChevronLeft/><span>السابق</span></button>
   <div><small>أمثلة الجمع</small><strong>{exampleIndex+1} / {A1_DEMONSTRATIVES_PLURAL_EXAMPLES.length}</strong><em dir="ltr">ces</em></div>
   <button type="button" onClick={()=>setExampleIndex(index=>Math.min(A1_DEMONSTRATIVES_PLURAL_EXAMPLES.length-1,index+1))} disabled={exampleIndex===A1_DEMONSTRATIVES_PLURAL_EXAMPLES.length-1} aria-label="المثال التالي"><span>التالي</span><ChevronRight/></button>
  </div>
 </div>;
}

const A1_POSSESSIVES_MON_MA_MES_EXAMPLES=[
 {article:"mon",kind:"مذكر مفرد",rule:"قبل اسم مذكر مفرد",phrase:"mon frère",ar:"أخي",sentence:"Mon frère travaille à Lyon.",sentenceAr:"أخي يعمل في ليون."},
 {article:"mon",kind:"مذكر مفرد",rule:"قبل اسم مذكر مفرد",phrase:"mon sac",ar:"حقيبتي",sentence:"Mon sac est sur la chaise.",sentenceAr:"حقيبتي على الكرسي."},
 {article:"mon",kind:"مذكر مفرد",rule:"قبل اسم مذكر مفرد",phrase:"mon téléphone",ar:"هاتفي",sentence:"Mon téléphone est dans ma poche.",sentenceAr:"هاتفي في جيبي."},
 {article:"mon",kind:"مذكر مفرد",rule:"قبل اسم مذكر مفرد",phrase:"mon ami",ar:"صديقي",sentence:"Mon ami arrive ce soir.",sentenceAr:"صديقي يصل هذا المساء."},
 {article:"mon",kind:"استثناء النطق",rule:"قبل مؤنث مفرد يبدأ بصوت متحرك",phrase:"mon école",ar:"مدرستي",sentence:"Mon école est près d’ici.",sentenceAr:"مدرستي قريبة من هنا."},
 {article:"ma",kind:"مؤنث مفرد",rule:"قبل اسم مؤنث مفرد يبدأ بصوت ساكن",phrase:"ma sœur",ar:"أختي",sentence:"Ma sœur est étudiante.",sentenceAr:"أختي طالبة."},
 {article:"ma",kind:"مؤنث مفرد",rule:"قبل اسم مؤنث مفرد يبدأ بصوت ساكن",phrase:"ma voiture",ar:"سيارتي",sentence:"Ma voiture est bleue.",sentenceAr:"سيارتي زرقاء."},
 {article:"ma",kind:"مؤنث مفرد",rule:"قبل اسم مؤنث مفرد يبدأ بصوت ساكن",phrase:"ma clé",ar:"مفتاحي",sentence:"Ma clé est sur la table.",sentenceAr:"مفتاحي على الطاولة."},
 {article:"ma",kind:"مؤنث مفرد",rule:"قبل اسم مؤنث مفرد يبدأ بصوت ساكن",phrase:"ma chambre",ar:"غرفتي",sentence:"Ma chambre est calme.",sentenceAr:"غرفتي هادئة."},
 {article:"ma",kind:"مؤنث مفرد",rule:"قبل اسم مؤنث مفرد يبدأ بصوت ساكن",phrase:"ma montre",ar:"ساعتي",sentence:"Ma montre est neuve.",sentenceAr:"ساعتي جديدة."},
 {article:"mes",kind:"جمع",rule:"قبل كل اسم في صيغة الجمع",phrase:"mes parents",ar:"والداي",sentence:"Mes parents habitent à Nice.",sentenceAr:"والداي يسكنان في نيس."},
 {article:"mes",kind:"جمع",rule:"قبل كل اسم في صيغة الجمع",phrase:"mes livres",ar:"كتبي",sentence:"Mes livres sont sur la table.",sentenceAr:"كتبي على الطاولة."},
 {article:"mes",kind:"جمع",rule:"قبل كل اسم في صيغة الجمع",phrase:"mes chaussures",ar:"حذائي",sentence:"Mes chaussures sont noires.",sentenceAr:"حذائي أسود."},
 {article:"mes",kind:"جمع",rule:"قبل كل اسم في صيغة الجمع",phrase:"mes amis",ar:"أصدقائي",sentence:"Mes amis parlent français.",sentenceAr:"أصدقائي يتحدثون الفرنسية."},
 {article:"mes",kind:"جمع",rule:"قبل كل اسم في صيغة الجمع",phrase:"mes photos",ar:"صوري",sentence:"Mes photos sont belles.",sentenceAr:"صوري جميلة."}
];

function A1PossessivesMonMaMesTable(){
 const [exampleIndex,setExampleIndex]=useState(0);
 const item=A1_POSSESSIVES_MON_MA_MES_EXAMPLES[exampleIndex];
 const groupStarts:{[key:string]:number}={mon:0,ma:5,mes:10};
 const selectGroup=(article:"mon"|"ma"|"mes")=>setExampleIndex(groupStarts[article]);
 return <div className="a1-demonstratives-table a1-possessives-table" aria-live="polite">
  <p className="a1-nouns-learning-intro">نختار الصيغة بحسب جنس الشيء المملوك وعدده، لا بحسب جنس المتكلم. اضغط على الصيغة أو تنقّل بين الأمثلة.</p>
  <div className="a1-demonstratives-tabs" role="group" aria-label="اختر صفة الملكية">
   <button type="button" className={item.article==="mon"?"active":""} aria-pressed={item.article==="mon"} onClick={()=>selectGroup("mon")}><strong dir="ltr">mon</strong><span>مذكر مفرد</span></button>
   <button type="button" className={item.article==="ma"?"active":""} aria-pressed={item.article==="ma"} onClick={()=>selectGroup("ma")}><strong dir="ltr">ma</strong><span>مؤنث مفرد</span></button>
   <button type="button" className={item.article==="mes"?"active":""} aria-pressed={item.article==="mes"} onClick={()=>selectGroup("mes")}><strong dir="ltr">mes</strong><span>الجمع</span></button>
  </div>
  <div className="a1-demonstratives-rule"><span dir="ltr">{item.article}</span><div><small>{item.kind}</small><strong>{item.rule}</strong></div></div>
  <div className="a1-demonstratives-grid" key={exampleIndex}>
   <div className="a1-demonstratives-cell"><small>الأداة + الاسم</small><strong dir="ltr"><mark>{item.article}</mark> {item.phrase.slice(item.article.length+1)}</strong><span>{item.ar}</span></div>
  ...
  <div className="university-number-pagination a1-demonstratives-pagination" dir="ltr">
   <button type="button" onClick={()=>setExampleIndex(index=>Math.max(0,index-1))} disabled={exampleIndex===0} aria-label="المثال السابق"><ChevronLeft/><span>السابق</span></button>
   <div><small>أمثلة mon، ma et mes</small><strong>{exampleIndex+1} / {A1_POSSESSIVES_MON_MA_MES_EXAMPLES.length}</strong><em dir="ltr">{item.article}</em></div>
   <button type="button" onClick={()=>setExampleIndex(index=>Math.min(A1_POSSESSIVES_MON_MA_MES_EXAMPLES.length-1,index+1))} disabled={exampleIndex===A1_POSSESSIVES_MON_MA_MES_EXAMPLES.length-1} aria-label="المثال التالي"><span>التالي</span><ChevronRight/></button>
  </div>
 </div>;
}
...
export default function UniversityPage({initialLevelId,initialModuleId,initialPhaseIndex,initialFocusModuleId,levelPage=false,lessonPage=false}:UniversityPageProps={}){
 ...
 const [auxPluralGroupIndex,setAuxPluralGroupIndex]=useState(0);
 const [auxPluralExampleIndex,setAuxPluralExampleIndex]=useState(0);
 const [pluralArticleGroupIndex,setPluralArticleGroupIndex]=useState(0);
 const [pluralArticleExampleIndex,setPluralArticleExampleIndex]=useState(0);
       ...
       {isA1Countries&&index===0?<CountryFlagExplorer/>:isA1Countries&&index===1?<NationalityFlagExplorer/>:isA1Countries&&index===2?<LanguageCards/>:isA1Present&&index===0?<A1PresentSimpleBranches intro={item.explanation}/>:isA1Present&&index===1?<A1PresentNegationBranches intro={item.explanation}/>:isA1CoreVerbs&&index<2?<A1GrammarCarousel groups={index===0?A1_SUBJECT_PRONOUN_GROUPS:A1_CORE_VERB_GROUPS} intro={item.explanation} isVerb={index===1}/>:isA1Tastes&&index===0?<A1TastesPreferenceStudio/>:isA1Tastes&&index===1?<><A1TastesPreferenceChoiceStudio/><A1TastesChoiceStudio/></>:isA1Tastes&&index===2?<A1TastesReasonStudio/>:isA1Demonstratives&&index===0?<A1DemonstrativesMasculineTable/>:isA1Demonstratives&&index===1?<A1DemonstrativesFeminineTable/>:isA1Demonstratives&&index===2?<A1DemonstrativesPluralTable/>:isA1Possessives&&index===0?<A1PossessivesMonMaMesTable/>:isA1Studies?<div className="a1-nouns-learning a1-studies-learning"><p className="a1-nouns-learning-intro">{item.explanation}</p><div className="a1-nouns-branches">{A1_STUDIES_LEARNING_GROUPS[index].branches.map((branch,branchIndex)=><details key={branch.fr} className="a1-nouns-branch"><summary><span className="a1-nouns-branch-number">{String(branchIndex+1).padStart(2,"0")}</span><span className="a1-nouns-branch-title"><strong dir="ltr">{branch.fr}</strong><b>{branch.ar}</b></span><ChevronDown/></summary><div className="a1-nouns-branch-content"><p>{branch.note}</p>{index===0&&branchIndex===0?<A1StudyPlacesCarousel/>:index===0&&branchIndex===1?<A1StudySubjectsCarousel/>:index===0&&branchIndex===2?<A1StudyVerbsCarousel/>:index===1&&branchIndex===0?<A1StudyProfessionsCarousel/>:index===1&&branchIndex===1?<A1ProfessionGenderCarousel/>:index===1&&branchIndex===2?<A1WorkplacesCarousel/>:index===2&&branchIndex===0?<A1StudyQuestionCarousel mode="informal"/>:index===2&&branchIndex===1?<A1StudyQuestionCarousel mode="formal"/>:index===3&&branchIndex===0?<A1StudyPresentationCarousel/>:index===3&&branchIndex===1?<A1StudyPresentationCarousel kind="profession"/>:index===3&&branchIndex===2?<A1StudyPresentationCarousel kind="place"/>:branch.examples.length>0&&<div className="a1-nouns-example-grid">{branch.examples.map(example=><button key={example.fr} type="button" onClick={()=>void speakFrench(example.fr,{rate:.74})} aria-label={`استمع إلى ${example.fr}`}><strong dir="ltr">{example.fr}</strong><span>{example.ar}</span><Volume2 aria-hidden="true"/></button>)}</div>}</div></details>)}</div></div>:isA1Nouns?<div className="a1-nouns-learning">
        ...
        <div className="a1-nouns-branches">
         {A1_NOUNS_LEARNING_GROUPS[index].branches.map((branch,branchIndex)=><details key={branch.fr} className="a1-nouns-branch">
          ...
          </div>:index===1&&branchIndex===1?<div className="a1-definite-articles a1-indefinite-articles">
           <div className="a1-definite-article-tabs" role="group" aria-label="اختر أداة التنكير">{A1_INDEFINITE_ARTICLE_CARDS.map((card,cardIndex)=><button key={card.article} type="button" className={indefiniteArticleCardIndex===cardIndex?"active":""} aria-pressed={indefiniteArticleCardIndex===cardIndex} onClick={()=>setIndefiniteArticleCardIndex(cardIndex)}><strong dir="ltr">{card.article}</strong><small>{card.title}</small></button>)}</div>
          ...
          </div>:index===2&&branchIndex===0?<div className="a1-regular-plural">
           <div className="a1-regular-plural-card" key={regularPluralExampleIndex} aria-live="polite">{(()=>{const example=A1_REGULAR_PLURAL_EXAMPLES[regularPluralExampleIndex];return <div className="a1-regular-plural-pair">
            <button type="button" onClick={()=>void speakFrench(example.singular,{rate:.74})} aria-label={`استمع إلى ${example.singular}`}><small>المفرد</small><strong dir="ltr">{example.singular}</strong><span>{example.singularAr}</span><Volume2 aria-hidden="true"/></button>
            <span className="a1-regular-plural-arrow" aria-hidden="true"><b dir="ltr">+ s</b><span>←</span></span>
          ...
          </div>:index===2&&branchIndex===2?<div className="a1-regular-plural a1-aux-plural">
           <div className="a1-aux-plural-tabs" role="group" aria-label="طريقة تكوين الجمع">{A1_AUX_PLURAL_GROUPS.map((group,groupIndex)=><button key={group.label} type="button" className={auxPluralGroupIndex===groupIndex?"active":""} aria-pressed={auxPluralGroupIndex===groupIndex} onClick={()=>{setAuxPluralGroupIndex(groupIndex);setAuxPluralExampleIndex(0)}}><strong dir={groupIndex===3?"rtl":"ltr"}>{group.label}</strong></button>)}</div>
           <p className="a1-aux-plural-note">{A1_AUX_PLURAL_GROUPS[auxPluralGroupIndex].note}</p>
           <div className="a1-regular-plural-card" key={`${auxPluralGroupIndex}-${auxPluralExampleIndex}`} aria-live="polite">{(()=>{const example=A1_AUX_PLURAL_GROUPS[auxPluralGroupIndex].items[auxPluralExampleIndex];return <div className="a1-regular-plural-pair">
            <button type="button" onClick={()=>void speakFrench(example.singular,{rate:.74})} aria-label={`استمع إلى ${example.singular}`}><small>المفرد</small><strong dir="ltr">{example.singular.slice(0,-example.singularEnding.length)}<mark>{example.singularEnding}</mark></strong><span>{example.singularAr}</span><Volume2 aria-hidden="true"/></button>
            <span className="a1-regular-plural-arrow" aria-hidden="true"><span>←</span></span>
            <button type="button" onClick={()=>void speakFrench(example.plural,{rate:.74})} aria-label={`استمع إلى ${example.plural}`}><small>الجمع</small><strong dir="ltr">{example.plural.slice(0,-example.pluralEnding.length)}<mark>{example.pluralEnding}</mark></strong><span>{example.pluralAr}</span><Volume2 aria-hidden="true"/></button>
           </div>})()}</div>
           <div className="university-number-pagination a1-regular-plural-pagination" dir="ltr"><button type="button" onClick={()=>setAuxPluralExampleIndex(index=>Math.max(0,index-1))} disabled={auxPluralExampleIndex===0} aria-label="مثال سابق"><ChevronLeft/><span>السابق</span></button><div><small>صيغة الجمع</small><strong>{auxPluralExampleIndex+1} / {A1_AUX_PLURAL_GROUPS[auxPluralGroupIndex].items.length}</strong></div><button type="button" onClick={()=>setAuxPluralExampleIndex(index=>Math.min(A1_AUX_PLURAL_GROUPS[auxPluralGroupIndex].items.length-1,index+1))} disabled={auxPluralExampleIndex===A1_AUX_PLURAL_GROUPS[auxPluralGroupIndex].items.length-1} aria-label="مثال تالٍ"><span>التالي</span><ChevronRight/></button></div>
          </div>:index===2&&branchIndex===3?<div className="a1-regular-plural a1-plural-articles">
           <div className="a1-plural-article-tabs" role="group" aria-label="نوع أداة الجمع">{A1_PLURAL_ARTICLE_GROUPS.map((group,groupIndex)=><button key={group.label} type="button" className={pluralArticleGroupIndex===groupIndex?"active":""} aria-pressed={pluralArticleGroupIndex===groupIndex} onClick={()=>{setPluralArticleGroupIndex(groupIndex);setPluralArticleExampleIndex(0)}}><strong>{group.label}</strong><span dir="ltr">{group.article}</span></button>)}</div>
           <p className="a1-plural-article-note">{A1_PLURAL_ARTICLE_GROUPS[pluralArticleGroupIndex].note}</p>
           <div className="a1-regular-plural-card" key={`${pluralArticleGroupIndex}-${pluralArticleExampleIndex}`} aria-live="polite">{(()=>{const group=A1_PLURAL_ARTICLE_GROUPS[pluralArticleGroupIndex];const example=group.items[pluralArticleExampleIndex];const singular=`${example.singularArticle}${example.singularArticle==="l’"?"":" "}${example.singularNoun}`;const plural=`${group.article} ${example.pluralNoun}`;return <div className="a1-regular-plural-pair">
            <button type="button" onClick={()=>void speakFrench(singular,{rate:.74})} aria-label={`استمع إلى ${singular}`}><small>المفرد</small><strong dir="ltr"><mark>{example.singularArticle}</mark>{example.singularArticle==="l’"?"":" "}{example.singularNoun}</strong><span>{example.singularAr}</span><Volume2 aria-hidden="true"/></button>
            <span className="a1-regular-plural-arrow" aria-hidden="true"><span>←</span></span>
            <button type="button" onClick={()=>void speakFrench(plural,{rate:.74})} aria-label={`استمع إلى ${plural}`}><small>الجمع</small><strong dir="ltr"><mark>{group.article}</mark> {example.pluralNoun.slice(0,-1)}<em>{example.pluralNoun.slice(-1)}</em></strong><span>{example.pluralAr}</span><Volume2 aria-hidden="true"/></button>
           </div>})()}</div>
           <div className="university-number-pagination a1-regular-plural-pagination" dir="ltr"><button type="button" onClick={()=>setPluralArticleExampleIndex(index=>Math.max(0,index-1))} disabled={pluralArticleExampleIndex===0} aria-label="مثال سابق"><ChevronLeft/><span>السابق</span></button><div><small>الأداة مع الجمع</small><strong>{pluralArticleExampleIndex+1} / {A1_PLURAL_ARTICLE_GROUPS[pluralArticleGroupIndex].items.length}</strong></div><button type="button" onClick={()=>setPluralArticleExampleIndex(index=>Math.min(A1_PLURAL_ARTICLE_GROUPS[pluralArticleGroupIndex].items.length-1,index+1))} disabled={pluralArticleExampleIndex===A1_PLURAL_ARTICLE_GROUPS[pluralArticleGroupIndex].items.length-1} aria-label="مثال تالٍ"><span>التالي</span><ChevronRight/></button></div>
    ...
    {lessonStage==="practice"&&<section ref={practiceStageRef} className={`university-practice-stage ${alphabetPracticeClosing?"a1-orbit-panel-closing":""}`} style={isA1OrbitLesson?{"--practice-origin-x":ALPHABET_PRACTICE_ORIGINS[alphabetPracticeStep][0],"--practice-origin-y":ALPHABET_PRACTICE_ORIGINS[alphabetPracticeStep][1]} as CSSProperties:undefined}>
     ...
     {isEnhancedLesson&&(!isA1OrbitLesson||(alphabetPracticeStep>=1&&alphabetPracticeStep<=3))&&<section className="a2-interactive-workshop a1-practice-step-panel">
      ...
      {(!isA1OrbitLesson?revisionWorkshopPanel==="builder":alphabetPracticeStep===2)&&<article className="a2-builder-panel">
       ...
       <div className={`a2-workshop-actions ${isA1Sounds||isA1Countries||isA1Nouns||isA1CoreVerbs||isA1Present?"a1-sounds-builder-actions":""}`}><button onClick={()=>setRevisionBuilderChecked(true)} disabled={revisionBuilderSelection.length!==revisionBuilderItem.tokens.length}><CheckCircle2/> تحقق</button><button className="secondary" onClick={()=>{setRevisionBuilderSelection([]);setRevisionBuilderChecked(false)}}><RotateCcw/> ابدأ من جديد</button>{isA1Sounds||isA1Countries||isA1Nouns||isA1CoreVerbs||isA1Present?<button className="secondary a1-builder-next" disabled={!revisionBuilderCorrect} onClick={()=>{if(revisionBuilderIndex===activeA2Builders.length-1){advanceAlphabetPractice();return}setRevisionBuilderIndex(index=>index+1);setRevisionBuilderSelection([]);setRevisionBuilderChecked(false)}}>{revisionBuilderIndex===activeA2Builders.length-1?<>إنهاء بناء الجمل <Orbit/></>:<>الجملة التالية <ChevronLeft/></>}</button>:revisionBuilderIndex<activeA2Builders.length-1&&<button className="secondary" disabled={isA1OrbitLesson&&!revisionBuilderCorrect} onClick={()=>{setRevisionBuilderIndex(index=>index+1);setRevisionBuilderSelection([]);setRevisionBuilderChecked(false)}}>الجملة التالية <ChevronLeft/></button>}</div>
       {revisionBuilderChecked&&<div className={`a2-workshop-feedback ${revisionBuilderCorrect?"correct":"wrong"} ${(isA1Sounds||isA1Countries||isA1Nouns||isA1CoreVerbs||isA1Present)&&revisionBuilderCorrect?"a1-sounds-builder-feedback":""}`}><strong>{revisionBuilderCorrect?"ترتيب صحيح.":"الترتيب يحتاج إلى مراجعة دون كشف الحل."}</strong>{revisionBuilderCorrect&&(isA1Sounds||isA1Countries||isA1Nouns||isA1CoreVerbs||isA1Present)&&<div className="a1-sounds-builder-explanation"><header><div><b dir="ltr">{revisionBuilderItem.answer.join(" ")}</b><span>{revisionBuilderItem.ar}</span></div><button type="button" onClick={()=>void speakFrench(revisionBuilderItem.answer.join(" "),{rate:.7})} aria-label="استمع إلى الجملة الصحيحة"><Volume2/> استمع</button></header>{isA1Sounds&&"soundNotes" in revisionBuilderItem&&Array.isArray(revisionBuilderItem.soundNotes)&&<ul>{revisionBuilderItem.soundNotes.map(note=><li key={`${note.word}-${note.detail}`}><b dir="ltr">{note.word}</b><span dir="ltr">{note.detail}</span></li>)}</ul>}{(isA1Countries||isA1Nouns||isA1CoreVerbs||isA1Present)&&"explanationAr" in revisionBuilderItem&&typeof revisionBuilderItem.explanationAr==="string"&&<div className="a1-countries-builder-note"><p>{revisionBuilderItem.explanationAr}</p>{"explanationFr" in revisionBuilderItem&&typeof revisionBuilderItem.explanationFr==="string"&&<small dir="ltr">{revisionBuilderItem.explanationFr}</small>}</div>}</div>}{!revisionBuilderCorrect&&!isA1OrbitLesson&&<p dir="ltr">{revisionBuilderItem.answer.join(" ")}</p>}</div>}
      </article>}
      {(!isA1OrbitLesson?revisionWorkshopPanel==="dialogue":alphabetPracticeStep===3)&&<div className="a2-dialogue-panel">
       {activeA2Dialogues.map((dialogue,index)=>{const selected=revisionDialogueAnswers[index];return <article key={dialogue.context}><div className="a2-dialogue-context"><i>{index+1}</i><div><strong dir="ltr">{dialogue.context}</strong>{"translation" in dialogue&&typeof dialogue.translation==="string"&&<small className="university-question-translation">{dialogue.translation}</small>}<span>{dialogue.prompt}</span></div><button onClick={()=>void speakFrench(isA1OrbitLesson?dialogue.context:dialogue.context.replace(/^.*?«|»$/g,""),{rate:.72})} aria-label={`استمع إلى الموقف ${index+1}`}><Volume2/></button></div><div className="a2-dialogue-choices" dir="ltr">{dialogue.choices.map((choice,choiceIndex)=><button key={choice} className={selected===choiceIndex?(choiceIndex===dialogue.correctIndex?"correct":"wrong"):""} onClick={event=>selectPracticeChoice(event.currentTarget,choiceIndex===dialogue.correctIndex,()=>setRevisionDialogueAnswers(current=>({...current,[index]:choiceIndex})))}><span>{String.fromCharCode(65+choiceIndex)}</span>{choice}</button>)}</div>{typeof selected==="number"&&<p className={selected===dialogue.correctIndex?"correct":"wrong"}><strong>{selected===dialogue.correctIndex?"اختيار مناسب.":"هذا الرد لا يناسب الموقف."}</strong> {isA1Nouns&&selected!==dialogue.correctIndex?"أعد قراءة السؤال واختر ردًا يجيب عنه مباشرة.":dialogue.feedback}</p>}</article>})}
      </div>}
     </section>}
     ...
     {isEnhancedLesson&&isA1OrbitLesson&&alphabetPracticeStep===5&&<section className="a1-smart-writing a1-practice-step-panel">
      ...
      <form onSubmit={event=>{event.preventDefault();setAlphabetWritingState(normalizeExerciseText(alphabetWritingInput)===normalizeExerciseText(alphabetWritingItem.fr)?"correct":"wrong")}}>
       <label htmlFor="alphabet-smart-writing">{isA1Greetings?"اكتب الكلمة أو العبارة بالفرنسية":isA1Nouns?"اكتب العبارة بالفرنسية مع أداتها":isA1CoreVerbs?"اكتب العبارة بالفرنسية":"اكتب الكلمة بالفرنسية"}</label>
      ...
      <div className="a1-smart-writing-actions">
       {alphabetWritingIndex<orbitWritingTranslations.length-1?<button type="button" className="next" disabled={alphabetWritingState!=="correct"} onClick={()=>{setAlphabetWritingIndex(index=>index+1);setAlphabetWritingInput("");setAlphabetWritingState("idle")}}>{isA1Greetings?"التالي":isA1WritingPhrase?"العبارة التالية":"الكلمة التالية"} <ChevronLeft/></button>:<button type="button" className="next complete" disabled={alphabetWritingState!=="correct"} onClick={()=>{setAlphabetWritingIndex(0);setAlphabetWritingInput("");setAlphabetWritingState("idle")}}><RotateCcw/> {isA1Greetings?"أعد التمرين":isA1WritingPhrase?"أعد العبارات":"أعد الكلمات"}</button>}
      </div>
     </section>}
