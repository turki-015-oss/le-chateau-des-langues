...
export default function UniversityPage({initialLevelId,initialModuleId,levelPage=false,lessonPage=false}:UniversityPageProps={}){
 ...
 const isA1WordDictation=isA1Alphabet||isA1Sounds;
 const writingMinimum=isA1Greetings?15:isEnhancedA1Lesson?8:60;
 const writingMaximum=isA1Greetings?25:isEnhancedA1Lesson?12:80;
