...
const anatomyZones:AnatomyZone[]=[
 {id:"head",fr:"La tête",ar:"الرأس",x:50,y:7,color:"#d9a56d",terms:[term("Le crâne","الجمجمة","عظام تحمي الدماغ"),term("Le cerveau","الدماغ","عضو الجهاز العصبي المركزي"),term("Le visage","الوجه","الجزء الأمامي من الرأس"),term("Le front","الجبهة","أعلى الوجه"),term("Les cheveux","الشعر","يغطي فروة الرأس"),term("Les dents","الأسنان","تقطع الطعام وتطحنه")]},
 {id:"senses",fr:"Les organes des sens",ar:"أعضاء الحواس",x:57,y:14,color:"#78a7c8",terms:[term("L’œil","العين","عضو البصر"),term("L’oreille","الأذن","عضو السمع والتوازن"),term("Le nez","الأنف","عضو الشم"),term("La langue","اللسان","عضو التذوق والكلام")]},
